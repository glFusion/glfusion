...
$_DATA[] = "INSERT INTO {$_TABLES['blocks']} (bid, is_enabled, name, type, title, tid, blockorder, content, rdfurl, rdfupdated, onleft, phpblockfn, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES (1,1,'user_block','gldefault','My Account','all',2,'','','0000-00-00 00:00:00',1,'',4,2,3,3,2,2) ";
...
$_DATA[] = "INSERT INTO {$_TABLES['links']} (lid, cid, url, description, title, hits, date, owner_id, group_id, perm_owner, perm_group, perm_members, perm_anon) VALUES ('glfusion.org', 'blog-roll', 'http://www.glfusion.org/', 'Visit glFusion - A site dedicated to enhancing glFusion.', 'glFusion - Enhancing glFusion', 1, NOW(), 1, 5, 3, 3, 2, 2);";
$_DATA[] = "INSERT INTO {$_TABLES['links']} (lid, cid, url, description, title, hits, date, owner_id, group_id, perm_owner, perm_group, perm_members, perm_anon) VALUES ('glfusion_manual', 'blog-roll', 'http://www.glfusion.org/filemgmt/index.php?id=220', 'The glFusion manual is a snapshot compilation of the living documentation in the online wiki. It is in .pdf format.', 'glFusion Manual', 1, NOW(), 1, 5, 3, 3, 2, 2);";
