...
<p>&nbsp;And more! Visit <a target=\"_blank\" href=\"http://www.glfusion.org/wiki/doku.php?id=glfusion:whatsnew\">www.glfusion.org</a> for a detailed list!</p>', 1, '0000-00-00 00:00:00', 'allblocks', 0, '', -1, 2, 14, 3, 2, 2, 2, 0, '', 'none', 1, 0, 0, 0, 'adveditor', 0) ";
...
<p>Their&nbsp;<a target=\"_blank\" href=\"http://mootools.net/docs/\">well-documented API</a> allows devs &amp; site admins to easily create a wide range of dynamic enhancements that extend the functionality in a <em><strong>glFusion</strong></em> powered site.</p>', 1, '0000-00-00 00:00:00', 'allblocks', 0, '', -1, 2, 14, 3, 2, 2, 2, 0, '', 'none', 1, 0, 0, 0, 'adveditor', 0) ";
...
<p>For a complete list of widgets,&nbsp;and how to configure them, visit the <a target=\"_blank\" href=\"http://www.glfusion.org/wiki/doku.php?id=glfusion:widgets\">glFusion documentation</a>.</p>', 1, '0000-00-00 00:00:00', 'allblocks', 0, '', -1, 2, 14, 3, 2, 2, 2, 0, '', 'none', 1, 0, 0, 0, 'adveditor', 0) ";
...
<p>It also eliminates redundant template files, which allows for streamlined development, customization &amp; delivery!</p>', 1, '0000-00-00 00:00:00', 'allblocks', 0, '', -1, 2, 14, 3, 2, 2, 2, 0, '', 'none', 1, 0, 0, 0, 'adveditor', 0) ";
...
<p>&nbsp;<img hspace=\"5\" height=\"16\" width=\"16\" align=\"top\" src=\"xxxSITEURLxxx/layout/nouveau/images/check.png\" alt=\"\" /><strong>Media Gallery</strong> - full-featured media management!</p>', 1, '0000-00-00 00:00:00', 'allblocks', 0, '', -1, 2, 14, 3, 2, 2, 2, 0, '', 'none', 1, 0, 0, 0, 'adveditor', 0) ";
...
<div id=\"gl_moorotator\">
	...
	<!-- repeat as needed -->
</div>', 1, '0000-00-00 00:00:00', 'leftblocks', 0, '', -1, 2, 14, 3, 2, 2, 2, 1, '', 'none', 1, 2, 0, 0, 'html', 0) ";
...
</script>', 1, '0000-00-00 00:00:00', 'allblocks', 0, '', 0, 2, 14, 3, 2, 2, 2, 0, '', 'none', 2, 0, 0, 0, 'html', 0) ";

$_DATA[] = "INSERT INTO {$_TABLES['blocks']} (bid, is_enabled, name, type, title, tid, blockorder, content, rdfurl, rdfupdated, onleft, phpblockfn, group_id, owner_id, perm_owner, perm_group, perm_members, perm_anon) VALUES (19,1,'moorotator','normal','Visit glFusion','all',10,'<script type=\"text/javascript\" src=\"xxxSITEURLxxx/javascript/mootools/gl_moorotator-block.js\"></script>
<script type=\"text/javascript\">
	window.addEvent(\'domready\', function() {
...
<!-- repeat as needed -->
</div>','','0000-00-00 00:00:00',1,'',4,2,3,2,2,2) ";
?>