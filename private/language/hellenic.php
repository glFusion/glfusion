...
$LANG32 = array(
    ...
    9 => 'Αυτό το εξωτερικό πρόγραμμα απαιτεί νεότερη έκδοση του glFusion. Η αναβαθμίστε την έκδοση σας του <a href="https://www.glfusion.org">glFusion</a> η βρείτε μία νεότερη έκδοση του.',
