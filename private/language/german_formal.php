...
$LANG01 = array(
    ...
    38 => 'Newsfeed',
    39 => 'Neuladen',
    40 => 'Sie haben <tt>register_globals = Off</tt> in ihrer <tt>php.ini</tt>. Für glFusion muss <tt>register_globals</tt> jedoch auf <strong>on</strong> stehen. Bitte ändern Sie dies auf <strong>on</strong> und starten Sie ihren Webserver neu.',
    41 => 'Gäste',
    42 => 'Autor:',
    ...
    57 => 'Passwort',
    58 => 'Anmelden',
    59 => "Noch nicht registriert? Registrieren Sie sich jetzt als <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">neuer Benutzer</a>",
    ...
    125 => 'Wollen Sie wirklich alle angekreuzten Einträge löschen?',
    ...
    505 => 'Diese Datenbankversion: %s<br />glFusion Scriptversion: %s<br />Bitte überprüfen Sie die Integrität dieser Seite!',
    'ctl' => 'Cache löschen',
    'logview' => 'Protokolle einsehen',
    'correct_perms' => 'Bitte korrigieren Sie die folgenden Hinweise. Nach erfolgter Korrektur den Button <b>Recheck</b> drücken, um die Umgebung zu validieren.',
    'current' => 'Aktuell',
...
$LANG04 = array(
    ...
    14 => 'Dieses Passwort wurde mit einem Zufallsgenerator erzeugt. Es wird empfohlen, das Passwort nach dem Anmelden sofort zu ändern. Um Ihr Passwort zu ändern, melden Sie sich bitte an und wählen dann den Punkt Mein Profil im Block Einstellungen.',
    ...
    23 => "Indem Sie sich bei {$_CONF['site_name']} registrieren, können Sie Artikel und Kommentare unter ihrem eigenen Namen veröffentlichen (andernfalls geht das nur anonym). Übrigens wird ihre E-Mail-Adresse <strong><em>niemals</em></strong> auf dieser Webseite angezeigt werden.",
    24 => 'Ihr Passwort wird ihnen an die angegebene E-Mail-Adresse gesendet.',
    25 => 'Passwort vergessen?',
    26 => 'Geben Sie <em>entweder</em> Ihren Benutzernamen <em>oder</em> die E-Mail-Adresse ein, mit der Sie sich registriert haben, und klicken Sie auf Passwort senden. Eine E-Mail mit einer Anleitung, wie Sie ein neues Passwort eingeben können, wird dann an die gespeicherte E-Mail-Adresse gesendet.',
    ...
    55 => 'Wenn Sie hier nichts ankreuzen, wird die Standard-Auswahl an Blöcken angezeigt. Sobald Sie beginnen, Blöcke anzukreuzen, werden auch nur noch diejenigen angezeigt, die angekreuzt sind! Die Standard-Blöcke sind <b>fett</b> markiert.',
    56 => 'Autoren',
    57 => 'Anzeigemodus',
    ...
    62 => 'Standardwert: 100',
    63 => "Ihr Passwort sollte in Kürze per E-Mail eintreffen. Bitten Sie beachte die Hinweise in der E-Mail und Danke für ihr Interesse an {$_CONF['site_name']}",
    64 => 'Kommentar-Einstellungen für',
    65 => "Anmeldung bei {$_CONF['site_name']}",
    66 => 'Bitte geben Sie ihren Benutzernamen und Passwort unten ein.',
    67 => 'Mitglied seit',
    68 => 'Angemeldet für',
    ...
    90 => 'Sie können hier jetzt ein neues Passwort für ihren Account eingeben. Ihr altes Passwort bleibt noch solange gültig, bis Sie dieses Formular absenden.',
    91 => 'Neues Passwort',
    ...
    94 => 'Lösche Account "%s"',
    95 => 'Sie können ihren Account löschen, indem Sie auf den "Account Löschen"-Button klicken. Artikel und Kommentare, die Sie unter diesem Account geschrieben hast, werden <strong>nicht</strong> gelöscht, werden aber fortan als vom Benutzer "Gast" geschrieben erscheinen.',
    96 => 'Account Löschen',
    97 => 'Account Löschen bestätigen',
    98 => 'Sind Sie sicher, dass Sie ihren Account löschen wollen? Sie werden sich danach nicht mehr anmelden können (es sei denn, Sie legen einen neuen Account an). Wenn Sie sich sicher sind, klicken Sie bitte noch einmal auf "Account Löschen".',
    ...
    115 => 'Ihr Account wurde gesperrt. Sie können sich nicht anmelden. Bitte wenden Sie sich an einen Administrator.',
    116 => 'Account noch nicht freigegeben',
    117 => 'Ihr Account muss erst noch von einem Administrator freigegeben werden. Sie können sich erst anmelden, wenn ihr Account freigegeben wurde.',
    118 => "Ihr Account für {$_CONF['site_name']} wurde jetzt freigeschaltet. Sie können sich jetzt auf der Website unter der unten angegebenen URL anmelden. Benutzen Sie dazu Ihren Benutzernamen (<username>) und das Passwort, das Sie bereits per E-Mail erhalten haben.",
    ...
    148 => 'Über Sie',
    149 => 'Hier können Sie eingeben, was andere Benutzer über Sie sehen können:<li>Die Tag-Zeile wird an Kommentare angefügt</li><li>In der Biographie können Sie etwas über sich erzählen</li><li>Sie können ihren PGP-Key hinterlegen</li>',
    ...
    167 => 'Aktivierungs-Email wird an ihre eMail-Adresse gesendet werden.',
    168 => 'Willkommen bei ',
    169 => 'Neue Aktivierungs E-Mail anfordern',
    170 => 'Bitte bewahren Sie diese E-Mail auf. Ihre Kontoinformationen sind wie folgt:',
    171 => 'Seiten URL',
    172 => 'Bitte besuchen Sie folgenden Link, um Ihr Konto zu aktivieren. (Der Aktivierungs-Link ist nur gültig für %d Stunden):',
    173 => 'Das Passwort wurde sicher in unserer Datenbank gespeichert und kann nicht abgerufen werden. Für den Fall, dass es vergessen wird, können Sie es zurücksetzen. Ein neues Passwort wird an die mit diesem Account verbundene E-Mailadresse versandt.',
    174 => 'Vielen Dank für die Registrierung.',
    175 => 'Für eine erneute Aktivierung, geben Sie bitte ihren Benutzernamen und das Passwort ein. Zur Aktivierungs wird eine E-Mail wird an Sie gesendet werden.',
    176 => 'Kennwort bestätigen',
    177 => 'Ihr Account erwartet eine Überprüfung. <br />Mit der Aktivierungs-eMail erhalten Sie einen Link, mit welchem der Account aktiviert werden kann.'
);
...
$LANG08 = array(
    ...
    36 => 'Sie erhalten diese Nachricht, weil Sie den %s Daily-Digest abonniert haben. Um ihn zu entfernen oder ihre Präferenzen zu ändern, bearbeiten Sie die <strong>Daily-Digest</strong> Präferenzen in <a href="%s/usersettings.php?mode=edit">Mein Account</a> - Inhaltssektion.',
    37 => 'Sie erhälten diese Nachricht, weil Sie den %s Daily-Digest abonniert haben. Um ihn zu entfernen oder ihre Präferenzen zu ändern, bearbeiten Sie bitte ihre Präferenzen für Daily-Digest in der %s/usersettings.php?mode=edit Mein Account - Inhaltssektion.'
);
...
$LANG09 = array(
    ...
    74 => 'Suche ergab kein Ergebnis. <br/><ul><li>Prüfen Sie bitte, ob die Schreibweise korrekt ist.</li><li>Benutzen Sie eine andere <strong>Suche</strong>, um ein anderes Ergebnis zu erzielen. <em>irgend eines der Wörter</em> liefert Ergebnisse, wenn <strong>Alle</strong> der Suchbegriffe im Text. <em>Alle Wörter</em> liefert nur Ergebnisse, wenn <strong>Alle</strong> Suchbegriffe angezeigt, und <em>genaue Wortgruppe</em> Liefert nur Ergebnisse, deren Suchbegriff dem Text entspricht. </li><li>Benutzen Sie für die Abfrage <strong>Filter Datum</strong> oder <strong>Filter Kategorie</strong>.</li></ul>',
    75 => '1 Tag',
    76 => '7 Tage',
    77 => '2 Wochen',
    78 => '1 Monat',
...
$LANG12 = array(
    ...
    8 => 'Absenden',
    9 => 'Wenn Sie Informationen einsenden möchten, die auf dieser Seite veröffentlicht werden sollen, dann bitten wir Sie, folgende Punkte zu beachten:<ul><li>Bitte alle Felder ausfüllen, sie werden benötigt<li>Bitte nur vollständige und exakte Informationen einsenden<li>URLs vor dem Absenden unbedingt noch einmal kontrollieren</ul>',
    10 => 'Titel',
    11 => '',
    12 => 'Startdatum',
    13 => 'Enddatum',
...
$LANG21 = array(
    ...
    29 => 'Block-Funktion',
    30 => 'Wenn einer Ihrer Blöcke PHP-Code verwenden soll, geben Sie hier bitte den Namen der Funktion ein. Der Funktionsname muss mit "phpblock_" (z.B. phpblock_getweather) beginnen. Wenn sie diese Namenskonvention nicht einhält, wird die Funktion NICHT aufgerufen. Das soll verhindern, dass Hacker evtl. gefährlichen Code einschleusen können. Den Funktionsnamen NICHT mit einem Klammerpaar "()" abschliessen. Ferner wird empfohlen, all Ihren Code für PHP-Blöcke in der Datei /pfad/zu/glfusion/system/lib-custom.php abzulegen. Dort kann der Code auch dann unverändert bleiben, wenn Sie auf eine neuere glFusion-Version umsteigen.',
...
$LANG27 = array(
    ...
    56 => 'Drücken Sie auf Abbrechen und dann auf Bearbeiten dieser Kategorie, zur Ansicht von Details wie die Gesamtzahl der Objekte in der Datenbank.'
);
...
$LANG28 = array(
    ...
    82 => "Ihr Account auf der Seite {$_CONF['site_name']} wurde seit %s Tagen nicht benutzt und wird deaktiviert, wenn er nicht innerhalb von 30 Tagen aufgerufen wird.",
    83 => "Ihr Account auf der Seite {$_CONF['site_name']} wurde seit der Einrichtung nicht benutzt \und wird gelöscht, wenn Sie sich nicht in Kürze anmelden.",
    84 => "Ihr Anmeldename ist: %s  auf der Seite: {$_CONF['site_url']}",
    85 => 'Wenn Sie das Passwort vergessen haben, benutzen folgenden Link: %s',
    86 => 'Einschließen',
    87 => 'Erinnnerungen',
    88 => 'Standardgruppe',
...
$LANG29 = array(
    ...
    46 => 'Eingereicht von',
    47 => 'Registriert am',
    48 => 'Sind Sie sicher, dieser Einsendung zuzustimmen?',
    49 => 'Sind Sie sicher, diese Einsendung zu löschen?',
...
$LANG31 = array(
    ...
    18 => 'An',
    19 => 'HINWEIS: Wenn Sie eine Nachricht an alle eingetragenen Benutzer senden wollen, müssen Sie die Gruppe Logged-in Benutzer auswählen.',
...
$MESSAGE = array(
    ...
    2 => "Danke für Ihren Beitrag zu {$_CONF['site_name']}. Ihr Artikel wurde an unser Team weitergeleitet. Wenn er akzeptiert wird, wird er bald auf dieser Webseite für alle Besucher zu lesen sein.",
    ...
    4 => '',
    5 => 'Ihr Benutzer-Profil wurde gespeichert.',
    ...
    16 => 'Sie wurden ausgetragen und erhälten keine Benachrichtigungen mehr.',
    17 => '',
    18 => '',
    19 => '',
    20 => '',
    ...
    32 => 'Sie Haben keinen Zugriff auf die Kategorie-Administrationsseite. Alle Versuche, auf Bereiche ohne entsprechende Berechtigung zuzugreifen, werden protokolliert.',
    ...
    35 => '',
    36 => '',
    37 => 'Sie Haben keinen Zugriff auf die Benutzer-Administrationsseite. Alle Versuche, auf Bereiche ohne entsprechende Berechtigung zuzugreifen, werden protokolliert.',
    ...
    77 => 'HINWEIS:<br' . XHTML . '>Sie haben UTF-8 als Standard-Zeichensatz angegeben. Ihr Webserver unterstützt jedoch kein "multibyte encoding". Installieren Sie bitte die mbstring-Erweiterungen für PHP oder benutzen Sie einen anderen Zeichensatz bzw. eine andere Sprache.',
    ...
    81 => 'Haben Sie sich vertippt? Bitte versuchen Sie es noch einmal, sich hier anzumelden.',
    ...
    91 => 'Sie haben eine ungültige Identität-URL spezifiziert.',
...
$LANG_FILECHECK = array(
    ...
    'expiration2' => '<ol><li>Erhöhen Sie den Wert der \'max_execution_time\' in der Datei php.ini.  Derzeit eingestellt sind: %s Sekunden.</li><li>Überprüfen Sie ihre Website manuell und entfernen Sie alle nicht benötigten Dateien und Verzeichnisse.</li></ol>',
    'abort' => 'Abbruch Scan',
...
$LANG_ACCESS = array(
    ...
    'securitygroupsmsg' => 'Mit den Checkboxen können Sie festlegen, zu welchen Gruppen dieser Benutzer gehört.',
    ...
    'yes' => 'Ja',
    'no' => 'Nein',
    'corerightsdescr' => "Diese Gruppe ist eine Core-Gruppe auf {$_CONF['site_name']}. Seien Sie sich sicher, dass Sie die Änderungen verstehen, die Sie hier machen können. Das Folgende ist eine Liste der Rechte dieser Gruppe.",
    ...
    'storydenialmsg' => "Sie haben nicht die erforderlichen Berechtigungen, um diesen Artikel zu lesen. Möglicherweise sind Sie kein registrierter Benutzer von {$_CONF['site_name']}. Bitte melden Sie sich als <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">neuer Benutzer</a> von {$_CONF['site_name']} an um vollen Zugriff auf alle Bereiche zu bekommen.",
    ...
    'canteditgroup' => 'Um diese Gruppe bearbeiten zu können, muüssen Sie selbst ein Mitglied der Gruppe sein. Wenden Sie sich bitte an den Systemadministrator wenn Sie der Meinung sind, dass das ein Fehler wäre.',
...
$LANG_401 = array(
    1 => 'Fehler 401',
    2 => '<p>Die angeforderten Daten sind zugangsgeschützt. </br>Der Server kann die Daten nur senden, wenn eine gültige Zugangskennung, bestehend aus Benutzername und Passwort, bei der Anfrage mit gesendet wird.</p>',
    3 => 'Ihre IP wurde ermittelt und protokolliert!',
    4 => 'Ihre IP-Adresse lautet:',
    5 => 'Ihr Hostname lautet:'
);
...
$LANG_403 = array(
    1 => 'Fehler 403',
    2 => '<p>Der Server möchte die angeforderten Daten nicht herausgeben. </br>Das passiert zum Beispiel wenn der Zugriff auf die Ressource von dem IP-Adress-Bereich, aus dem die Anfrage kommt,</br>in der Serverkonfiguration verboten wurde, die Ressource ganz und gar gesperrt wurde oder man versucht, ein Verzeichnislisting zu bekommen, dies jedoch in der Serverkonfiguration abgeschaltet wurde.</p>',
    3 => 'Ihre IP wurde ermittelt und protokolliert!',
    4 => 'Ihre IP-Adresse lautet:',
    5 => 'Ihr Hostname lautet:'
);
...
$LANG_404 = array(
    ...
    3 => "<p>Sorry, diese Seite oder Datei existiert nicht. Sie können es auf der <a href=\"{$_CONF['site_url']}\">Startseite</a> oder mit der <a href=\"{$_CONF['site_url']}/search.php\">Suchfunktion</a> probieren, vielleicht werden Sie ja fündig ...</p>"
);
...
$LANG_LOGIN = array(
    ...
    2 => 'Sorry, aber um auf diesen Bereich zugreifen zu können, müssen Sie als Benutzer angemeldet sein.',
    3 => 'Anmelden',
    4 => 'Neuer Benutzer'
);
...
$LANG_confignames['Core'] = array(
    ...
    'site_slogan' => 'Slogan',
    'microsummary_short' => 'Kurzzusammenfassung',
