...
$LANG01 = array(
    ...
    39 => 'Actualización',
    40 => 'Tienes <tt>register_globals = Off</tt> en tu <tt>php.ini</tt>. Sin embargo, glFusion requiere que <tt>register_globals</tt> esté <strong>on</strong>. Antes de continuar, por favor ajústalo a <strong>on</strong> y reinicia tu servidor web.',
    ...
    'view_online' => 'Clic aquí %s para ver en linea',
...
$LANG03 = array(
    ...
    24 => 'Usuario Anónimo',
    25 => 'Estas seguro que quieres denunciar este mensaje al administrador del sitio?',
...
$LANG04 = array(
    ...
    65 => 'Intenta registrarte otra vez',
    66 => "Los datos ingresados no son válidos. Intenta ingresar de nuevo. ¿Eres un <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">usuario nuevo</a>?",
    67 => 'Miembro desde',
    ...
    125 => '¡Debes escribir el mismo e-mail en ambis campos!',
    ...
    132 => 'Resumen Diario Caracteristicas',
    133 => 'Comentarios',
    ...
    181 => 'Categoría',
    182 => 'Descripción',
    183 => 'Notificación de Subscripciones',
...
$LANG21 = array(
    ...
    23 => 'Orden',
    24 => '',
    25 => 'Para modificar o borrar, haz clic sobre el icono: <img src="'.$_CONF['layout_url'].'/images/edit.png" /> correspondiente. Para crear, haz clic en el enlace: "<b>Crear</b>" arriba. Para mover, haz clic en las flechas o las cajas [R] (<i>para mover a la derecha</i>) y [L] (<i>para mover a la izquierda</i>).',
    ...
    45 => "Estás intentando acceder a un Bloque al que no tienes permisos de acceso. Este intento se ha registrado. Por favor <a href=\"{$_CONF['site_admin_url']}/block.php\">regresa a la pantalla de administración de Bloques</a>.",
    46 => 'Mover',
    47 => '',
    48 => 'Nombre',
...
$LANG24 = array(
    ...
    40 => '',
    41 => "Estás intentando acceder a una Noticia a la que no tienes permisos de acceso, por lo que podrás ver la Noticia pero no editarla. Por favor vuelve a la <a href=\"{$_CONF['site_admin_url']}/story.php\">página de administración</a> cuando hayas terminado.",
    42 => "Estás intentando acceder a una Noticia a la que no tienes permisos de acceso. Por favor vuelve a la <a href=\"{$_CONF['site_admin_url']}/story.php\">página de administración</a>.",
    43 => '',
    44 => '',
    45 => '',
    ...
    55 => 'Los siguientes errores ocurrieron al querer guardar tu Noticia. Por favor corrige los errores antes de guardar.',
...
$LANG27 = array(
    ...
    9 => 'Para modificar o borrar, haz clic sobre el icono: <img src="'.$_CONF['layout_url'].'/images/edit.png" /> correspondiente. Para crear, haz clic sobre el enlace: "<b>Crear</b>" arriba. Encontrarás tu nivel de acceso para tema en paréntesis. <img src="'.$_CONF['layout_url'].'/images/admin/check.png" /> denota el tema  por defecto.',
    10 => 'Secuencia',
    11 => 'Noticias/Página',
    12 => 'Acceso Denegado',
    13 => "Estás intentando acceder a un Tema al que no tienes permisos de acceso. Por favor vuelve a la <a href=\"{$_CONF['site_admin_url']}/topic.php\">página de administración.",
...
$LANG28 = array(
    ...
    104 => '¿Estas seguro de querer borrar este Usuario?',
    105 => 'Estado',
    106 => 'Queued',
    107 => 'Verification',
    108 => 'View Profile',
...
$LANG29 = array(
    ...
    'info' => 'Usa este panel para Modificar, Aprobar o Borrar aportes. La opción de cola de contribuciones para algún tipo de elemento debe ser habilitada en la configuración de glFusion o de la Extensión para que los elementos queden en cola aquí para la aprobación administrativa.<br /><br />Para ver o modificar un elemento recibido, haz clic en el icono <img src="'.$_CONF['layout_url'].'/images/edit.png" /> correspondiente. Para aprobar o borrar uno o más elementos, haz clic en la caja de chequeo correspondiente a cada elemento, y luego haz clic en el icono de acción correspondiente. Ten en cuenta que solamente un tipo de elemento puede ser moderado a la vez.  '
);
...
$LANG32 = array(
    ...
    7 => 'La Extensión que intenta instalar ya existe. Por favor borra la Extensión antes de reinstalarla.',
    ...
    31 => '¿Estás seguro que quieres borrar esta Extensión ? Al hacerlo borrarás todos los archivos, estructuras y datos asociados. Si estás seguro/a selecciona "Borrar" en el formulario de abajo.',
...
$LANG33 = array(
    ...
    13 => 'Para modificar o borrar, haz clic sobre el icono: <img src="'.$_CONF['layout_url'].'/images/edit.png" /> correspondiente. Para crear, haz clic sobre el enlace: "<b>Crear</b>" arriba.',
    14 => 'Título',
    15 => 'Teclea',
    16 => 'Archivo',
    17 => 'Formato',
...
$MESSAGE = array(
    ...
    77 => 'WARNING:<br' . XHTML . '>You have set your default encoding to UTF-8. However, your server does not support multibyte encodings. Please install mbstring funciones for PHP or choose a different character set/language.',
...
$LANG_ACCESS = array(
    ...
    'newgroupmsg' => 'Para modificar o borrar, haz clic sobre el icono: <img src="'.$_CONF['layout_url'].'/images/edit.png" /> correspondiente. Para crear, haz clic el enlace: "<b>Crear</b>" arriba. Ten en cuenta que los Grupos del Sistema no se pueden borrar.',
    'groupname' => 'Grupo',
    'coregroup' => 'Sistema',
    'yes' => 'Sí',
    'no' => 'No',
    ...
    'cancel' => 'Cancelar',
    'delete' => 'Borrar',
    'canteditroot' => 'Has intentado editar el grupo Root (Raíz) pero no perteneces al grupo Root por lo que se te ha denegado el acceso.  Por favor, contacta con el administrador del sistema si crees que se trata de un errror',
    ...
    'canteditgroup' => 'Para editar este grupo, tiene que ser un miembro del grupo. Por favor, contacta con el administrador del sistema si crees que esto es un error.',
    'cantlistgroup' => 'Para ver los miembros de este grupo, tiene que ser un miembro tú mismo. Por favor contacta con el administrador del sistema i crees que esto es un error.',
...
$LANG_DB_BACKUP = array(
    ...
    'db_explanation' => 'Haz clic en: <b>Crear</b> para generar una copia de seguridad del sistema',
...
$LANG_ADMIN = array(
    ...
    'create_new' => '<img src="'.$_CONF['layout_url'].'/images/admin/add.png" /> Crear',
...
$LANG_FILECHECK = array(
    ...
    'recheck' => 'Comprobar',
    'confirm' => '¿Estas seguro que deseas borrar los archivos seleccionados?',
    ...
    'working' => 'Explorando, por favor espera...<br />',
...
$LANG_AM = array(
    ...
    'replace_explain'           => 'Autoetiquetas take the form <b>[tag:{p1} {p2}]</b>. In the <b>Replacement</b> field you can use any valid HTML. You can include {p1} and/or {p2} parameters in your replacement string by using the replacement macros %1% and %2% respectively.'
                                .'<p>Autoetiquetas are commonly used to create links. A <b>Replacement</b> field of <b>&lt;a href="http://path.to.somewhere/%1%"&gt;%2%&lt;/a&gt;</b> when combined with this tag: <b>[tag:foo This is a link]</b> will result in the string <b>&lt;a href="http://path.to.somewhere/foo"&gt;This is a link&lt;/a&gt;</b></p>'
...
$LANG_UPGRADE = array(
    'recheck' => 'Comprobar',
    'desc' => 'Asegúrate que tanto el software glFusion como las Extensiones están al día. La comprobación solicita al sitio web glFusion.org  las ultimas versiones de todo el software y compara con las versiones instaladas.',
    ...
    'was_released' => 'Versión %s was released on %s.',
...
$LANG_confignames['Core'] = array(
    ...
    'allow_mysqldump' => 'Permitir MySQL Dump',
    'mysqldump_path' => 'Ruta del Ejecutable',
    'mysqldump_options' => 'Opciones para MySQL Dump',
    'theme' => 'Plantilla',
    ...
    'atom_max_stories' => 'Máx. de Noticias en Difusión Webservices',
    'disable_webservices' => 'Deshabilitar Webservices',
    'restrict_webservices' => 'Restringir Webservices',
    ...
    'bb2_ban_enabled' => 'Habilitar Baneado Automático',
    'bb2_display_stats' => 'Mostrar Estadisticas',
