...
$LANG01 = array(
    ...
    129 => 'Configuración',
    130 => 'Webservices',
    500 => '¡Por favor borre el directorio: admin/install/ !',
...
$LANG04 = array(
    ...
    65 => 'Intenta conectarte otra vez',
    66 => "Los datos ingresados no son válidos. Intenta reconectar abajo. Eres un <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">usuario nuevo</a>?",
    67 => 'Miembro desde',
    68 => 'Recuérdeme durante',
...
$LANG21 = array(
    ...
    23 => 'Orden',
    24 => '',
    25 => 'Para modificar o borrar un bloque, selecciona el icono de acción correspondiente. Para crear uno, selecciona "crear" arriba. Para mover un bloque, haz clic en las flechas o las cajas [R] (<i>para mover a la derecha</i>) y [L] (<i>para mover a la izquierda</i>).',
    26 => 'Bloque de maquetación',
    27 => 'Bloque PHP',
    28 => 'Bloque PHP',
    29 => 'Funciones del Bloque',
    30 => 'Si quiere que su bloque utilice código PHP, ingrese aquí el nombre de la función. La función tiene que tener el prefijo "phpblock_" (ej. phpblock_getweather). De no tenerlo NO será invocada. Asegúrese de no incluir los paréntesis, "()", al final del nombre. Por último, se recomienda que guarde todo el código PHP en: /path/to/glfusion/system/lib-custom.php. Esto te permitirá que su código se mantenga aún entre cambios de versiones del sistema.',
    31 => 'Error en un Bloque PHP.  La función, %s, no existe.',
    32 => 'Error, Faltan Campos',
    33 => 'Tiene que ingresar el URL del archivo .rdf para los Bloques del Sistema',
    34 => 'Tiene que ingresar el Título y la Función en los Bloques PHP',
    35 => 'Tiene que ingresar el Título y el Contenido para los Bloques Normales',
    36 => 'Tiene que ingresar el contenido para los Bloques de Maquetación',
    ...
    40 => 'Izquierda',
    41 => 'Derecha',
    42 => 'Tiene que ingresar el orden y el nivel de seguridad para los bloques por defecto',
    ...
    50 => '',
    51 => 'incluya: <b>http://</b>',
    52 => 'Si deja este campo en blanco no se mostrará el icono de ayuda',
    53 => 'Habilitado',
    54 => 'guardar',
    55 => 'cancelar',
    56 => 'borrar',
    ...
    65 => 'Secuencia',
    66 => 'Autotags:',
    67 => '<i>Seleccione para permitir autotags</i>',
...
$LANG24 = array(
    ...
    23 => '<b>Nota</b>: Para ver una Noticia haga clic en su <b>Título</b>.',
    24 => 'La ID que has elegido para este tema ya está siendo utilizada. Por favor, utiliza otra ID.',
    25 => 'Error when saving story',
    26 => 'Lectura Previa',
    27 => 'Si usa: [unscaledX] envés de: [imageX], la imagen será insertada es su tamaño original.',
    28 => '<p><b>VISUALIZACIÓN</b>: Para Visualizar una Noticia con imágenes adjuntas es mejor guardarla como borrador primero EN VEZ de emplear el botón Visualizar.  Use el botón Visualizar únicamente cuando no hayan imágenes adjuntas.',
    29 => 'Trackbacks',
    ...
    49 => 'der',
    50 => 'izq',
    51 => 'Para insertar una imagen en la Noticia tiene que incluir un texto con el formato: [imageX], [imageX_right] o [imageX_left], donde X es el número de imagen dentro de la lista.<br /><b>NOTA</b>: Sólo puede utilizar las imágenes de la lista, si no la Noticia no se podrá guardar. ',
    52 => '',
    53 => 'no se ha utilizado.  Tiene que incluir esta imagen en la Introducción o el Texto para poder guardar los cambios',
...
$LANG27 = array(
    ...
    11 => 'Noticias/Página',
    12 => 'Acceso Denegado',
    13 => "Estás intentando acceder a un Tema al que no tienes derechos de acceso. Por favor vuelve a la <a href=\"{$_CONF['site_admin_url']}/topic.php\">página de administración.",
...
$LANG32 = array(
    ...
    7 => 'El Módulo que intenta instalar ya existe. Por favor borre el Módulo antes de reinstalarlo.',
    ...
    11 => 'Para modificar o borrar un Módulo selecciona el número a la izquierda del mismo. Para acceder a la página de sus creadores seleccione en el título del Plug-in. Para instalar un nuevo Plug-in selecciona \'Nuevo Plug-in\' más arriba.',
    ...
    31 => 'Estás seguro que quiere borrar este Módulo ? Al hacerlo borrarás todos los archivos, estructuras y datos asociados. Si estás seguro/a selecciona "Borrar" en el formulario de abajo.',
...
$LANG_ACCESS = array(
    ...
    'groupmsg' => 'Los Grupos de Seguridad en este sitio son jerárquicos. Al agregar este grupo a cualquiera de los de abajo le estará dando los mismos derechos que esos grupos posean. De ser posible, se recomienda utilizar los grupos ya creados para dar los derechos a un nuevo grupo. Si tiene que modificar los derechos del grupo, puedes seleccionarlos en la sección llamada \'Derechos\'. Para agregar este grupo a cualquiera de los de abajo simplemente marca los grupos que quieras.',
...
$LANG_DB_BACKUP = array(
    ...
    'db_explanation' => 'Pulse Crear para generar una copia de seguridad del sistema',
...
$LANG_AM = array(
    ...
    'enabled' => 'Habilitado ?',
    'click_to_enable' => 'Click para habilitar.',
    'click_to_disable' => 'Click para deshabilitar.',
    'function' => 'PHPfn?',
...
$LANG_confignames['Core'] = array(
    ...
    'postmode' => 'Modo de Envío predeterminado',
    ...
    'disable_autolinks' => '¿Deshabilitar Autolinks?',
    ...
    'search_def_keytype' => 'Metodo de Busqueda Predeterminado',
...
$LANG_configsubgroups['Core'] = array(
    'sg_site' => 'Sitio',
    'sg_stories' => 'Noticias y Trackback',
    'sg_theme' => 'Diseño',
    'sg_blocks' => 'Bloques',
...
$LANG_fs['Core'] = array(
    ...
    'fs_caching' => 'Cache',
    'fs_mulitlanguage' => 'Soporte Multilenguaje - Ver <a href="http://www.glfusion.org/wiki/doku.php/glfusion:language#multilingual_sites" target=_blank>Documentación Multi-Language</a>',
    'fs_logo' => 'Logo',
