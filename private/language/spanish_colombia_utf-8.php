...
$LANG01 = array(
    ...
    124 => 'Clic para borrar todos los items seleccionados',
    ...
    'autotag_perms' => 'Autoetiqueta Permissions',
    'subscribe' => 'Suscribirse',
    'unsubscribe' => 'Cancelar Suscribción',
...
$LANG03 = array(
    ...
    47 => 'Notificame via e-Mail cuando nuevos comentarios o respuestas sean publicadas pare este item.',
...
$LANG04 = array(
    ...
    130 => 'Acerca de',
    131 => 'Resumen Diario Options',
    132 => 'Resumen Diario Feature',
    133 => 'Comentarios',
    ...
    141 => 'Privacidad',
    142 => 'El ajustes por defecto permite a usuarios y administradores enviar e-mails a miembros del sitio y mostrar su estado cuando estan en linea. Deselecciona estas opciones para proteger tu privacidad.',
...
$LANG29 = array(
    ...
    'info' => 'Usa este panel para Modificar, Aprobar o Borrar aportes. La opción de cola de contribuciones para algún tipo de elemento debe ser habilitada en la configuración de glFusion o del Módulo para que los elementos queden en cola aquí para la aprobación administrativa.<br /><br />Para ver o modificar un elemento recibido, haz clic en el icono <img src="'.$_CONF['layout_url'].'/images/edit.png" /> correspondiente. Para aprobar o borrar uno o más elementos, haz clic en la caja de chequeo correspondiente a cada elemento, y luego haz clic en el icono de acción correspondiente. Ten en cuenta que solamente un tipo de elemento puede ser moderado a la vez.  '
);
...
$LANG32 = array(
    1 => 'La instalación de Módulos puede dañar tu instalación de glFusion y, posiblemente, tu sistema. Es importante que sólo instale Módulos obtenidos de <a href="http://www.gllabs.org" target="_blank">glFusion</a> ya que han sido comprobados en varios entornos. Es también importante que entiendas que la instalación del Módulo requiere la ejecución de instrucciones del sistema que pueden traer problemas de seguridad. Aún con esta advertencia, no garantizamos el éxito de la instalación del Módulo ni nos hacemos responsables por cualquier daño causado durante la instalación (<i>o posterior a la misma</i>). En otras palabras, instala el Plug-in a tu propio riesgo. Las instrucciones particulares de instalación vienen dentro de cada Módulo.',
    2 => 'Advertencia de la instalación del Módulo',
    3 => 'Formulario de instalación del Módulo',
    4 => 'Archivo del Módulo',
    5 => 'Módulos',
    6 => 'Advertencia: ¡El Módulo ya está instalado!',
    7 => 'El Módulo que intenta instalar ya existe. Por favor borra el Módulo antes de reinstalarlo.',
    8 => 'Falló la comprobación de compatibilidad del Módulo',
    9 => 'Este Módulo requiere una versión más nueva de glFusion. Puede obtener una copia actualizada de <a href=http://www.gllabs.org>glFusion</a> o instalar otra versión del Módulo.',
    10 => '<br' . XHTML . '><b>No hay Módulos instalados.</b><br' . XHTML . '><br' . XHTML . '>',
    11 => 'Para modificar o borrar un Módulo selecciona el número a la izquierda del mismo. Para acceder a la página de sus creadores seleccione en el título del Módulo. Para instalar un nuevo Módulo selecciona \'Nuevo Plug-in\' más arriba.',
    12 => 'no se ha dado un nombre de Módulo a la función plugineditor()',
    13 => 'Editor de Módulo',
    14 => 'Nuevo Módulo',
    ...
    28 => 'Versión',
    29 => 'Ver. glFusion',
    30 => 'Quiere borrar el Módulo ?',
    31 => '¿Estás seguro que quieres borrar este Módulo ? Al hacerlo borrarás todos los archivos, estructuras y datos asociados. Si estás seguro/a selecciona "Borrar" en el formulario de abajo.',
    ...
    57 => 'Seleccione el archivo del Módulo en su equipo para cargarlo a su sitio web.',
    58 => 'Cargar',
    59 => 'Cancelar',
    60 => 'Instalar',
    61 => 'Actualizar',
...
$MESSAGE = array(
    ...
    34 => '',
    35 => '',
    36 => 'The Autoetiqueta permissions have been successfully saved.',
...
$LANG_AM = array(
    ...
    'enabled' => 'Habilitada',
    'click_to_enable' => 'Clic para habilitar.',
    'click_to_disable' => 'Clic para deshabilitar.',
    'function' => 'PHP',
    ...
    'php_msg_norights' => '<br />NOTE: PHP Autoetiquetas are enabled, however the current user has not been assigned the \'autoetiqueta.PHP\' feature, and therefore cannot create new PHP Autoetiquetas and/or enable or disable existing PHP Autoetiquetas.',
    ...
    'phpfn_missing' => 'The class: \'%s.class.php\' does not exist in the autoetiqueta/ directory.',
    'phpfn_must_exist' => 'You must create this class and place it in system/autoetiqueta/ directory before defining the associated PHP-based Autoetiqueta.',
    'phpfn_replace' => 'This tag will be expanded by a call to the PHP class {tag}.class.php.',
    'html_allowed' => '(HTML:OK)',
    'instructions' => 'Para modificar o borrar, haz clic sobre el icono: <img src="'.$_CONF['layout_url'].'/images/edit.png" /> correspondiente. Para crear, haz clic en el enlace: "<b>Crear</b>" arriba. <p>Si hay una Autoetiqueta basada en una función de PHP que no puedes modificar o habilitar, es por que: 1) No tienes acceso a las características: <i>autoetiqueta.PHP</i> y/o 2) Autoetiquetas PHP están deshabilitadas en el panel de configuración del Administrador del Módulo de Autoetiquetas.</p>',
    'public_instructions' => 'La lista completa de Autoetiquetas que están actualmente disponibles y habilitadas en este sitio se muestran a continuación. Para cada Autoetiqueta, el módulo de contribución de glFusion mostrado, así como, el Tipo y Descripción. Ejemplos de uso son proporcionados con los parámetros: <i>requerido</i> y {opcional}. Cuando múltiples opciones están disponibles, se provee un enlace para la documentación wiki de glFusion.org.',
...
$LANG_UPGRADE = array(
    'recheck' => 'Comprobar',
    'desc' => 'Asegúrate que tanto el software glFusion como los Módulos están al día. La comprobación solicita al sitio web glFusion.org  las ultimas versiones de todo el software y compara con las versiones instaladas.',
    ...
    'plugin_newer' => 'Esta ejecutando una versión mas nueva del Módulo.',
    ...
    'plugin_title' => 'Verificador de versión de Módulos',
    'plugin' => 'Módulo',
...
$LANG_confignames['Core'] = array(
    ...
    'hidenewplugins' => 'Ocultar Módulos Nuevos',
