...
$LANG04 = array(
    ...
    140 => '<li>No Topic Icons if checked will not display the story topic icons</li><li>No Blocks if checked will only show the Admin Menu, User Menu and Topics</li><li>Set the maximum number of stories to show per page</li><li>Set your timezone and perferred date format</li>',
...
$LANG32 = array(
    ...
    11 => 'To enable or disable installed plugins, click the associated checkbox in the Control column.  Plugins that have been uploaded to your system may be installed by clicking the Install icon in the Control column.  To upgrade the data associated with an upgraded plugin, click the Update icon that is displayed.  To delete (uninstall) a plugin, click the Delete icon.',
    ...
    29 => 'glFusion Version',
    30 => 'Delete Plugin?',
    31 => 'Are you you absolutely sure you want to delete (uninstall) this Plugin?  By doing so you will permanently remove all of the data that is associated with this Plugin from the database.',
