...
$LANG04 = array(
    ...
    140 => '<li>No Topic Icons if checked will not display the story topic icons</li><li>No Blocks if checked will only show the Admin Menu, User Menu and Topics</li><li>Set the maximum number of stories to show per page</li><li>Set your theme, timezone and perferred date format</li>',
