...
$LANG01 = array(
    ...
    57 => 'Password',
    58 => 'Login',
    59 => "Sign up as a <a href=\"%s/users.php?mode=new\" rel=\"nofollow\">New User</a>",
    60 => 'Post a comment',
    ...
    119 => "Lost your <a href=\"%s/users.php?mode=getpassword\" rel=\"nofollow\">password</a>?",
...
$LANG03 = array(
    1 => 'Post a Comment',
    2 => 'Post Mode',
    3 => 'Logout',              // depreciated
    4 => 'Create Account',      // depreciated
    5 => 'User name',
    // depreciated
    ...
    13 => 'Your Information',   // depreciated
    14 => 'Preview',
    15 => 'Report this post',
    16 => 'Title',
    17 => 'Error',
    ...
    40 => 'If you wish to receive no further notifications of replies, visit the following link: ', // depreciated
    41 => 'Edit a Comment',
...
$LANG04 = array(
    ...
    11 => 'No User Comments',       // depreciated
    12 => 'User Preferences for',   // depreciated
    ...
    15 => "Your %s account has been created successfully. To be able to use it, you must login using the information below. Please save this mail for further reference.",
    16 => 'Account Information',
    17 => 'Account does not exist', // depreciated
    18 => 'The email address provided does not appear to be a valid email address',
    19 => 'The user name or email address provided already exists',
    20 => 'The email address provided does not appear to be a valid email address', // ddepriated
    21 => 'Error',
    22 => "Register with %s!",		// depreciated
    23 => "Register for %s membership.<br>Your email address will <b><i>never</i></b> be publicly displayed on this site.",
    ...
    87 => 'Your login name',
    88 => "Someone (possibly you) has requested a new password for your account \"%s\" on %s, <%s>.\n\nIf you really want this action to be taken, please click on the following link:\n\n",
    ...
    101 => 'Allow email from Site Administrators',
    ...
    118 => "Your %s account has now been activated by an administrator. You may now login to the site at the URL below using your user name (%s) and password as previously emailed to you.",
    119 => 'If you have forgotten your password, you may request a new one at this URL:',
    120 => 'Account Activated',
    121 => 'Service',
    122 => 'Sorry, new user registration is disabled',
    123 => "Are you a <a href=\"%s/users.php?mode=new\" rel=\"nofollow\">new user</a>?",
    124 => 'Confirm email',
    ...
    140 => '<li>No Topic Icons if checked will not display the story topic icons</li><li>No Blocks if checked will only show the Admin Menu, User Menu and Topics</li><li>Set the maximum number of stories to show per page</li><li>Set your time zone and preferred date format</li>',
    141 => 'Privacy Settings',
    142 => 'The default setting is to allow users &amp; administrators to email fellow site members and show your status as on line. Uncheck these options to protect your privacy.',
...
$LANG08 = array(
    ...
    23 => "This email was sent to you by %s at %s because they thought you might be interested in this article from %s. This is not SPAM and the email addresses involved in this transaction were not saved to a list or stored for later use.",
    ...
    27 => 'Short message',
    28 => '%s wrote: ',
    29 => "This is the daily digest from %s for",
...
$LANG09 = array(
    ...
    17 => 'Date',
    18 => 'Author',
    19 => "Search the entire %s database of current and past content.",
    20 => 'Date',
    21 => 'to',
...
$LANG12 = array(
    ...
    31 => " seconds ago. This site requires at least %s seconds between submissions",
    32 => 'Preview',
    33 => 'Story Preview',
    34 => 'Log Out',
...
$LANG20 = array(
    ...
    4 => 'User name:',
    5 => 'Password:',
    6 => 'Administrative access to this site is for authorized personnel only.<br>All access is logged and reviewed.',
    7 => 'login',
...
$LANG28 = array(
    ...
    8 => 'Homepage',
    9 => '(do not use spaces)',
    10 => 'Please fill in the User name and email Address fields',
    11 => 'User Administration',
    12 => 'To modify or delete a user, click on that user\'s edit icon below. To view a user, click on the user name you wish to view. To create a new user, click on "Create New" above.',
    13 => 'SecLev',
    14 => 'Registered',
    15 => 'New User',
    16 => 'Awaiting User Verification',
    20 => 'save',
    21 => 'The user name you tried saving already exists.',
    22 => 'Error',
    23 => 'Batch Import',
    24 => 'Batch Import of Users',
    25 => 'You can import a batch of users into glFusion.  The import file must be a tab-delimited text file and must have the fields in the following order: full name, user name, email address.  Each user you import will be emailed with a random password.  You must have one user entered per line.  Failure to follow these instructions will cause problems that may require manual work so double check your entries!',
    ...
    51 => 'Online Days',
    52 => '<br/>Note: "On-line Days" is the number of days between the first registration and the last login.',
    53 => 'Reg',
    54 => 'Batch Admin',
    ...
    82 => "Your account on %s has not been accessed since %s and will be disabled if not accessed in the next 30 days.",
    83 => "Your account on %s has not been used since it was created and will be deleted soon if not accessed.",
    84 => "Your login name is: %s for our site: %s",
...
$MESSAGE = array(
    1 => "Your password has been emailed to you and should arrive momentarily. Please follow the directions in the message.",
    2 => "Thank-you for submitting your story.  It has been submitted to our staff for approval. If approved, your story will be available for others to read on our site.",
    3 => "A verification email has been sent to you and should arrive momentarily. Please follow the directions in the message.",
    ...
    48 => "Thank you for applying for a membership. Our team will review your application. If approved, your password will be emailed to you at the email address you just entered.",
    49 => 'Your group has been successfully saved.',
    50 => 'The group has been successfully deleted.',
    51 => 'This user name is already in use. Please choose another one.',
    ...
    94 => 'Backup Failed: File size less than 1kb',
...
$LANG_ACCESS = array(
    ...
    'editrootmsg' => "Even though you are a User Administrator, you can't edit a root user without first being a root user yourself.  You can edit all other users except root users. Please note that all attempts to edit root users are logged.  Please go back to the <a href=\"%s/user.php\">User Administration page</a>.",
...
$LANG_configSelect['Core'] = array(
    ...
    5 => array('plaintext' => 'Text', 'html' => 'HTML'),
    6 => array(12 => '12', 24 => '24'),
