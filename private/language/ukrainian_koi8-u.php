...
$LANG01 = array(
    ...
    38 => 'Експорт контенту',
    39 => 'Оновити',
    40 => 'У вашому <tt>php.ini</tt> встановлено <tt>register_globals = Off</tt>. Проте glFusion потребу╓ встановлення <tt>register_globals</tt> в <strong>on</strong>. Перш н╕ж продовжувати, будь-ласка, встанов╕ть цю директиву в <strong>on</strong> ╕ перезапуст╕ть ваш вебсервер.',
    41 => 'Гост╕',
    42 => 'Автор:',
    43 => 'В╕дпов╕сти',
    44 => 'Вгору',
...
$LANG21 = array(
    ...
    29 => 'Функц╕я блоку',
    30 => 'Якщо Ви бажа╓те, щоб один ╕з блок╕в використовував PHP код, введ╕ть ╕м\'я функц╕╖. Ваша функц╕я повинна починатися з преф╕кса "phpblock_" (наприклад, phpblock_getweather). Якщо вона не ма╓ вказаного преф╕кса, то ╖╖ не буде викликано. Це зроблено для того, щоб не дозволити людям, як╕ можуть зламати ваш glFusion, викликати функц╕╖,що ╓ небезпечними для вашо╖ системи. Не розм╕щуйте порожн╕ дужки "()" п╕сля назви Вашо╖ функц╕╖. Ми рекоменду╓мо розм╕щувати код функц╕й в /path/to/glfusion/system/lib-custom.php. Це дозволить Вам зберегти код у раз╕ переходу до ново╖ верс╕╖ glFusion.',
...
$LANG28 = array(
    ...
    25 => 'Ви можете ╕мпортувати групу користувач╕в у glFusion. ╤мпортований файл повинен бути текстовим файлом ╕з таб-розм╕ткою ╕ повинен мати поля в такому порядку: повне ╕м\'я, ╕м\'я користувача, адреса електронно╖ пошти. Кожому користувачев╕, доданому вами, буде над╕слано випадковий пароль. Ви повинн╕ мати в одному рядку одного користувача. Недотримання цих вимог призведе до помилок ╕ потреби ручно╖ роботи, отже дв╕ч╕ перев╕рте введен╕ дан╕!',
    26 => '',
    27 => '',
...
$LANG32 = array(
    1 => 'Встановлення модуля може пошкодити glFusion або нав╕ть ваш╕й систем╕. Важливо, щоб ви встановлювали лише модул╕, завантажен╕ з <a href="https://www.glfusion.org" target="_blank">Домашньо╖ стор╕нки glFusion</a>, оск╕льки ми тесту╓мо вс╕ модул╕, що нам присилають, на р╕зних операц╕йних системах. Важливо, щоб ви розум╕ли, що встановлення модул╕в вимага╓ виконання деяких системних команд, як╕ можуть викликати проблеми з безпекою, особливо це стосу╓ться модул╕в, завантажених не з нашого сайту. Якщо нав╕ть п╕сля цього попередження ви все ж продовжите, ми не можемо гарантувати усп╕шн╕сть ╕нсталяц╕╖ ╕ не несемо в╕дпов╕дальност╕ за проблеми, викликан╕ встановленням модуля glFusion. ╤накше кажучи, ви встановлю╓те модуль на св╕й ризик. Кер╕вництво з ручного встановлення модуля включено в кожний ╕нсталяц╕йний пакет.',
    ...
    9 => 'Модуль потребу╓ б╕льш ново╖ верс╕╖ glFusion. Онов╕ть Вашу коп╕ю <a href="https://www.glfusion.org">glFusion</a> або спробуйте знайти ╕ншу верс╕ю модуля.',
...
$LANG_TRB = array(
    ...
    'autodetect_failed' => 'glFusion не зм╕г визначити трекбек-URL для поста, до якого ви хочете над╕слати коментар. Будь-ласка, введ╕ть його вручну нижче.',
    'trackback_explain' => 'З посилань нижче, обер╕ть URL на який ви хочете в╕д╕слати ваш трекбек-коментар. glFusion спробу╓ визначити правильний трекбек-URL для цього поста. Або ви можете <a href="%s">ввести його вручну,</a> якщо уже зна╓те його.',
