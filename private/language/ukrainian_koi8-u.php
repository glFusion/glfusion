...
$LANG32 = array(
    1 => 'Встановлення модуля може пошкодити glFusion або нав╕ть ваш╕й систем╕. Важливо, щоб ви встановлювали лише модул╕, завантажен╕ з <a href="http://www.gllabs.org" target="_blank">Домашньо╖ стор╕нки glFusion</a>, оск╕льки ми тесту╓мо вс╕ модул╕, що нам присилають, на р╕зних операц╕йних системах. Важливо, щоб ви розум╕ли, що встановлення модул╕в вимага╓ виконання деяких системних команд, як╕ можуть викликати проблеми з безпекою, особливо це стосу╓ться модул╕в, завантажених не з нашого сайту. Якщо нав╕ть п╕сля цього попередження ви все ж продовжите, ми не можемо гарантувати усп╕шн╕сть ╕нсталяц╕╖ ╕ не несемо в╕дпов╕дальност╕ за проблеми, викликан╕ встановленням модуля glFusion. ╤накше кажучи, ви встановлю╓те модуль на св╕й ризик. Кер╕вництво з ручного встановлення модуля включено в кожний ╕нсталяц╕йний пакет.',
