...
$LANG_ACCESS = array(
    ...
    'token_expired' => 'Die Authentifizierung ist abgelaufen. Bitte bestätige Deine Sitzung erneut.',
    'token_expired_footer' => 'Die Authentifizierung für diese Handlung ist abgelaufen. Bitte bestätige Deine Sitzung erneut.',
...
$LANG_DB_ADMIN = array(
    ...
    'db_explanation' => '<ul><li>Um ein neues Backup der Datenbank anzulegen, bitte oben auf "Neu anlegen" klicken.</li><li>Ein Klick auf einen Dateinamen lädt das Backup herunter.',
    'backup_instructions' => '<ul><li>Um eine neue Sicherung der Datenbank zu erstellen, wähle unten die Schaltfläche "Sicherung anlegen". Dadurch werden alle aktuellen glFusion-Tabellen gesichert.</li><li>Du kannst eine Kopie Deiner Sicherung vom Hauptfenster der Datenbank-Administration herunterladen.</li></ul>',
...
$LANG_MB01 = array(
    ...
    'confirm_delete' => 'Möchtest Du diesen Menü-Element wirklich löschen?',
...
$LANG_MB_ADMIN = array(
    1 => '<ul><li>Mit dem Menü Manager kannst Du Menüs für Deine Website erstellen und bearbeiten.</li><li>Um ein neues Menü hinzuzufügen, klicke oben auf "Neues Menü erstellen".</li><li>Um die Elemente eines Menüs zu bearbeiten, klicke auf das entsprechende Bearbeiten-Symbol in der Spalte "Elemente".</li><li>Um die Menü-Eigenschaften zu ändern, klicke auf das entsprechende Symbol in der Spalte "Optionen".</li></ul>',
    ...
    3 => '<ul><li>Klicke auf das Symbol unter der Spalte "Bearbeiten", um die Eigenschaften eines Menü-Elementes zu bearbeiten.</li><li>Ordne die Elemente an, indem Du sie mit den Pfeilen unter der Spalte "Reihenfolge" nach oben oder unten verschiebst.</li></ul>',
    4 => 'Um ein neues Menüelement zu erstellen, gib seinen Namen, seine Details, seinen Status und seine Berechtigungen an.',
    5 => 'Sobald ein Element erstellt wurde, kannst Du jederzeit zu ihm zurückkehren und seine Details und seine Berechtigungen bearbeiten.',
...
$LANG_ENVCHK = array(
    ...
    'gd_not_found' => 'GDlib-Erweiterung konnten nicht gefunden werden. Bitte stelle sicher, dass die GDlib-Erweiterung vorhanden ist, oder wähl eine Alternative aus.',
