...
$LANG33 = array(
    ...
    37 => 'У вас встановлено принаймні один модуль, що підтримує експорт контенту. Нижче вам потрібно обрати, хочете ви створити стрічку glFusion чи стрічку одного з модулів.',
