...
//@TODO fix language tag
    $T->set_var(array(
        ...
        'top_pagination'        => COM_printPageNavigation($_MG_CONF['site_url'] . '/index-all.php',$page+1,ceil($total_items_in_album  / $media_per_page)),
        'bottom_pagination'     => COM_printPageNavigation($_MG_CONF['site_url'] . '/index-all.php', $page+1,ceil($total_items_in_album  / $media_per_page)),
