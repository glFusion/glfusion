...
$LANG_SX00 = array(
    ...
    'impinst2a' => 'Seiten, die ihre Blacklists tauschen, hinzugefügt wird. (Hinweis: Wenn Du mehrere Seiten hast, dann bestimmte',
    ...
    'readme' => 'STOPP! Bevor Du auf Installieren klickst, lese bitte das ',
    ...
    'allow_url_fopen' => '<p>Sorry, Deine Websever-Konfiguration erlaubt das lesen von Remote-Dateien nicht (<code>allow_url_fopen</code> ist aus). Bitte downloade die Blacklist von der folgenden URL and lade sie in glFusion\'s "data" Ordner hoch, <tt>%s</tt>, bevor Du es erneut versuchst:',
