 ...
 *
 * Please note that in order to use this class, you must have a vaild {@link https://akismet.com Akismet API key}.  They are free for non/small-profit types and getting one will only take a couple of minutes.
 *
...
class SocketWriteRead implements AkismetRequestSender {
	...
	public function send($host, $port, $request, $responseLength = 1160) {
		...
		$fs = fsockopen($host, $port, $this->errorNumber, $this->errorString, 5);
