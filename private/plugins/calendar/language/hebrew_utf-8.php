...
$LANG_CAL_1 = array(
    ...
    26 => 'הגשת אירוע',
    27 => "הגשת אירוע ל-{$_CONF['site_name']} תשים את האירוע שלכם ביומן הראשי ממנו משתמשים יכולים להוסיף את האירוע שלכם ליומן האישי שלהם. אופציה זו <b>*אינה*</b> אמורה לשמש לשמירת האירועים הפרטיים שלכם כמו ימי הולדת וימי שנה.<br><br>ברגע שתגישו את האירוע שלכם הוא ישלח למנהלים ואם יאושר, האירוע שלכם יופיע ביומן הראשי.",
    28 => 'כותרת',
    29 => 'זמן סיום',
    30 => 'זמן התחלה',
    31 => 'אירוע של יום שלם',
...
$LANG_CAL_ADMIN = array(
    ...
    28 => ' חודשים. אנא ליחצו על אייקון האשפה כדי למחוק אותם, או סמנו תקופת זמן שונה:<br>חפשו את כל האירועים אשר יותר ישנים מאשר ',
    29 => '',
    30 => 'רשימת עדכונים',
