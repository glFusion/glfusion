...
$LANG_CAL_1 = array(
    ...
    26 => 'Enviar un Evento',
    27 => "Al enviar un evento a <b>{$_CONF['site_name']}</b> este sera publicado en el Calendario Público, donde los usuarios pueden, opcionalmente, agregarlo a sus calendarios personales. Esta caracteristica <b>NO</b> es para almacenar sus eventos personales tales como cupleaños y aniversarios.<br><br>Una vez enviado será evaluado por los administradores y si es aprobado, será publicado en el calendario público.<br><br>",
    28 => 'Título',
    29 => 'Hora',
    30 => 'Hora',
    31 => 'Todo el Día',
