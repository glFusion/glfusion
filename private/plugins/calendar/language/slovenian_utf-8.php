...
# language file for glFusion version 1.0.0 by mb
...
$LANG_CAL_1 = array(
    ...
    26 => 'Oddaj dogodek',
    27 => "Oddaja dogodka na spletnem mestu {$_CONF['site_name']} bo tvoj dogodek dodala na glavni koledar, od koder lahko uporabniki tvoj dogodek dodajo v svoje osebne koledarje. Ta funkcija <b>NI</b> namenjena shranjevanju osebnih dogodkov, kot so rojstni dnevi in obletnice.<br" . XHTML . "><br" . XHTML . ">Ko svoj dogodek oddaš, bo poslan upravnikom, in če bo odobren, se bo pojavil v glavnem koledarju.",
    28 => 'Naslov',
    29 => 'Končni čas',
    30 => 'Začetni čas',
