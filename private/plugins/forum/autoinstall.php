...
$INSTALL_plugin['forum'] = array(
  ...
  array('type' => 'table', 'table' => $_TABLES['ff_thanks_assoc'], 'sql' => $_SQL['ff_thanks_assoc']),
...
function plugin_autouninstall_forum ()
{
    $out = array (
        ...
        'tables' => array('ff_topic','ff_categories','ff_forums','ff_settings','ff_moderators','ff_banned_ip', 'ff_log', 'ff_userprefs','ff_userinfo','ff_attachments','ff_bookmarks','ff_rating_assoc', 'ff_badges', 'ff_ranks', 'ff_thanks_assoc'),
