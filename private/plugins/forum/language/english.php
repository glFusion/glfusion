...
$LANG_GF01['BOOKMARKS']      = 'Bookmarks';
$LANG_GF01['LASTX']          = 'Latest Posts';
...
$LANG_confignames['forum'] = array(
    ...
    'allow_user_dateformat'     => 'Allow user defined Date/Time format where required?',
    'show_topicreview'          => 'Show Topic Review (Iframe) when replying?',
