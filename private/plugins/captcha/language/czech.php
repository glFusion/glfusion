...
$LANG_CP00 = array(
    ...
    'access_denied_msg' => 'Nemá¹ odpovídající práva k pøístupu na tuto stránku. Tvé u¾ivatelské jméno a IP adresa jsou zaznamenány.',
    ...
    'on' => 'On',
    'off' => 'Off',
    'captcha_alt' => 'Musí¹ zadat grafický text - pokud nemù¾e¹ pøeèíst obrázek, kontaktuj Admina',
    'save' => 'Ulo¾',
    'cancel' => 'Zru¹it',
    'success' => 'Configuration Options successfully saved.',
    'reload' => 'Znovu naèíst obrázek',
    'reload_failed' => "Sorry, cannot autoreload CAPTCHA image\nSubmit the form and a new CAPTCHA will be loaded",
    'reload_too_many' => 'Mù¾e¹ si vy¾ádat nejvý¹e 5 obrázkù',
    'session_expired' => 'Tvé CAPTCHA sezení skonèilo, zkus to znova',
    'picture' => 'Obrázek',
    'characters' => 'Písmena',
