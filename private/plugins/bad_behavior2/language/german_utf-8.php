...
$LANG_BAD_BEHAVIOR = array(
    ...
    'blacklist_info_text' => 'Du kannst verschiedene Arten von Verboten angeben. UserAgent am Textanfang, UserAgent beliebig im Text, UserAgent Regex, URL Text, Referer Text oder eine IP Adresse oder ein Bereich von IP Adressen im CIDR Format. Weitere Informationen zum Einrichten von Verboten findest Du in der <a href="https://www.glfusion.org/wiki/glfusion:bb2" target="_blank"> glFusion\'s Bad Behavior2 Plugin-Dokumentation </a>.',
    ...
    'date' => 'Datum',
    'delete' => 'Löschen',
    'delete_bl_confirm_1' => 'Bist Du sicher, dass Du die ausgewählten Blacklist-Einträge entfernen möchtest?',
    ...
    'delete_wl_confirm_1' => 'Bist Du sicher, dass Du die ausgewählten Whitelist-Einträge entfernen möchtest?',
    'denied_reason' => 'Grund',
    'description' => 'Bad Behaviour ergänzt andere Link-Spam-Lösungen, indem es als Gatekeeper fungiert und verhindert, dass Spammer ihren Müll bei Dir abladen bzw. Deine Seite überhaupt erst besuchen. Dies hält die Belastung Deiner Seite niedrig, hält Deine Log-Einträge sauberer und kann Denial of Service Angriffe verhindern.',
    ...
    'enter_ip_info' => 'Gib die IPs ein, die von der Website blockiert werden sollen. Jede IP sollte in einer eigenen Zeile sein.',
    'error' => 'Fehler',
    ...
    'whitelist_info_text' => 'Du kannst eine IP-Adresse, einen Bereich von IP-Adressen im CIDR-Format, UserAgent oder URLs angeben. Ein auf der Whitelist befindliches Element wird niemals durch den Spam-Schutz von glFusion blockiert.',
