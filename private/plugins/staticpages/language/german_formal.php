...
$LANG_STATIC = array(
    ...
    'no_page_access_msg' => "Dies könnte passiert sein, weil Sie nicht angemeldet sind, oder kein Mitglied von {$_CONF['site_name']} sind. Bitte <a href=\"{$_CONF['site_url']}/users.php?mode=new\">Registrieren</a> bei {$_CONF['site_name']}, um vollen Zugriff zu erhalten.",
    'php_msg' => 'PHP: ',
    ...
    'centerblock' => 'Mittel-Block',
    'centerblock_msg' => 'Wenn angekreuzt wird diese Statische-Seite als Mittel-Block angezeigt.',
    'topic' => 'Kategorie: ',
    'position' => 'Position: ',
    'all_topics' => 'Alle',
