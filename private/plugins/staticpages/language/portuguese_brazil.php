...
$LANG_STATIC = array(
    ...
    'php_not_activated' => "O uso de PHP em páginas estáticas não está ativado. Por favor veja a <a href=\"{$_CONF['site_url']}/docs/staticpages.html#php\">documentação</a> para saber de mais detalhes.",
