...
$LANG_configSelect['ckeditor'] = array(
    ...
    2 => array('grid'=>'grid', 'list' => 'lijst'),
    3 => array('default' => 'standaard', 'NAME_ASC'=>'Name (asc)', 'NAME_DESC'=>'Name (desc)', 'TYPE_ASC'=>'Type (asc)', 'TYPE_DESC'=>'Type (desc)', 'MODIFIED_ASC'=>'Modified (asc)', 'MODIFIED_DESC'=>'Modified (desc)'),
);
