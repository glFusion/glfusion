...
$LANG_CK00 = array(
    ...
    'install_success' => 'CKEditor-Installation erfolgreich.<br /><br />Bitte lesen Sie die Dokumentation durch und besuchen Sie die <a href="%s">Kommandozentrale</a> um sicherzustellen, dass Ihre Einstellungen zu Ihrer Hosting-Umgebung passen.',
    ...
    'details' => 'Das CKEditor-Plugin stellt Ihnen WYSIWYG-Editor-Funktionen zur Verfügung.',
    ...
    'preinstall_confirm' => "Für weitere Details zum Installieren des CKEditor, schauen Sie bitte in die <a href=\"{$_CONF['site_admin_url']}/plugins/ckeditor/install_doc.html\">Installationsanleitung</a>.",
    'visual' => 'Visuell',
    'html' => 'HTML'
);
