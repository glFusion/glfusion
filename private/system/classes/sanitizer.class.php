...
// depreciated
    ...
    public function htmlspecialchars($text, $flag = ENT_NOQUOTES)
    {
        return (@htmlspecialchars ($text,$flag, $this->encoding,true));
    }
