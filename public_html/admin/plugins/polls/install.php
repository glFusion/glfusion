...
if (!SEC_inGroup('Root')) {
    ...
    Log::write('system',Log::ERROR,'Someone has tried to access the Polls install/uninstall page.  User id: '.$_USER['uid'].', IP: ' . $_SERVER['REAL_ADDR']);
...
if (SEC_checkToken()) {
    ...
    if ($action == 'install') {
    	...
    	if (plugin_uninstall_polls('installed')) {
    		/**
    		* Redirects to the plugin editor
    		*/
