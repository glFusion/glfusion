...
if (!SEC_inGroup('Root')) {
    ...
    Log::write('system',Log::ERROR,'Someone has tried to access the CAPTCHA install/uninstall page without the proper permissions.  User id: '.$_USER['uid'].', IP: '.$_SERVER['REAL_ADDR']);
