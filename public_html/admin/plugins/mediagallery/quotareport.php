...
// +---------------------------------------------------------------------------+
// | $Id:: quotareport.php 1990 2008-02-13 04:22:12Z mevans0263               $|
// | Quota report.                                                             |
// +---------------------------------------------------------------------------+
...
if (!SEC_hasRights('mediagallery.config')) {
    ...
    COM_errorLog("Someone has tried to illegally access the Media Gallery Quota Report.  User id: {$_USER['uid']}, Username: {$_USER['username']}, IP: " . $_SERVER['REMOTE_ADDR'],1);
