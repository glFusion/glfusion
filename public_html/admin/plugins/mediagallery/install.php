...
*
* Installation driver for Media Gallery
*
...
if (!SEC_inGroup('Root')) {
    ...
    Log::write('system',Log::WARNING,"Someone has tried to access the Media Gallery install / uninstall page.  User id: ".$_USER['uid']);
