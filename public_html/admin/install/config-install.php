...
function install_config($site_url)
{
    ...
    $c->add('hideviewscount',0,'select',1,1,0,60,TRUE);
    $c->add('hideemailicon',0,'select',1,1,0,70,TRUE);
    $c->add('hideprintericon',0,'select',1,1,0,80,TRUE);
    $c->add('digg_enabled',0,'select',1,1,0,90,TRUE);
    $c->add('rating_enabled',1,'select',1,1,24,100,TRUE);
    $c->add('allow_page_breaks',1,'select',1,1,0,110,TRUE);
    $c->add('page_break_comments','last','select',1,1,7,120,TRUE);
    $c->add('article_image_align','right','select',1,1,8,130,TRUE);
    $c->add('show_topic_icon',1,'select',1,1,0,140,TRUE);
    $c->add('draft_flag',0,'select',1,1,0,150,TRUE);
    $c->add('frontpage',1,'select',1,1,0,160,TRUE);
    $c->add('hide_no_news_msg',0,'select',1,1,0,170,TRUE);
    $c->add('hide_main_page_navigation',0,'select',1,1,0,180,TRUE);
    $c->add('onlyrootfeatures',0,'select',1,1,0,190,TRUE);
    $c->add('aftersave_story','list','select',1,1,9,200,TRUE);
    ...
    $c->add('comment_limit',100,'text',4,6,NULL,20,TRUE);
    $c->add('comment_mode','nested','select',4,6,11,30,TRUE);
    $c->add('comment_code',0,'select',4,6,17,40,TRUE);
    ...
    $c->add('ip_lookup','/nettools/whois.php?domain=*','text',7,7,NULL,10,FALSE);
