...
$LANG_INSTALL = array(
    ...
    'filemgmt'                  => '加载下载管理插件？',
    'filemgmt_desc'             => '下载管理器，让您非常容易就能提供按照目录组织的文件下载服务。',
    'filesystem_check'          => '文件系统检查',
    'forum'                     => '加载论坛插件？',
    'forum_desc'                => '一个在线论坛系统，提供社区协作与交流功能。',
    'geeklog_migrate'           => '从Geeklog v1.5+ 站点迁移',
    'hosting_env'               => '服务器环境检测',
    'install'                   => '安装',
    'install_heading'           => 'glFusion安装工具',
    'install_steps'             => '安装步骤',
    'invalid_geeklog_version'   => '安装工具找不到siteconfig.php文件。您确信自己是从Geeklog v1.5.0或更高版本进行网站迁移吗？如果您使用的是Geeklog的较旧版本，请先升级到至少是Geeklog v1.5.0版本，然后重试。',
    'language'                  => '语言',
    'language_task'             => '语言与任务',
    'libcustom_not_writable'    => 'lib-custom.php文件不可写',
    'links'                     => '加载友情链接插件？',
    'links_desc'                => '一个友情链接管理系统，提供按照目录分类的友情链接。',
    'load_sample_content'       => '加载默认示例网站数据吗？',
    'mediagallery'              => '加载多媒体管理插件？',
    'mediagallery_desc'         => '一个多媒体管理系统，不仅可以配置成一个简单的相册，还能支持音乐和电影。',
    ...
    'php_req_version'			=> 'glFusion要求PHP版本不低于4.3.0.',
    'php_settings'				=> 'PHP配置',
    'php_version'				=> 'PHP版本',
    ...
    'site_noreply_email_error'  => '不监控不能为空。',
    ...
    'sitedata_help'             => '<br />从下拉菜单选择数据库类型。通常是<strong>MySQL</strong>。同时也选择是否使用<strong>UTF-8</strong>字符集(对于多语言站点一般需要选择该选项)。<br /><br /><br />输入数据库服务器的主机名。可能会和您的web服务器不同，当您不确定时请咨询服务器提供商。<br /><br /><br />输入数据库名称。<strong>数据库必须已经存在。</strong>如果您不知道数据库的名字，请联系您的服务器提供商。<br /><br /><br />输入数据库用户名。如果您不知道数据库用户名，请联系服务器提供商。<br /><br /><br />输入数据库密码，如果您不知道该密码请联系服务器提供商。<br /><br /><br /><br />输入一个数据表前缀，表前缀可以用来在一个数据库中区分多个网站的数据表。<br /><br /><br />输入您网站的名字，它将会显示为网站标题。例如glFusion或Mark\'s Marbles。不必担心，您可以在以后再更改它。<br /><br /><br />请输入网站副标题。它将会显示在网站标题下方。例如synergy - stability - style。不必担心，您可以在以后再更改它。<br /><br /><br />输入您网站的主电子邮件地址。该地址将被作为默认管理员的电邮.不必担心，您可以在以后再更改它。<br /><br /><br />输入您网站的不监控电邮地址。该地址将被用来发送自动生成的电子邮件、重置密码信、或其他提醒邮件。不必担心，您可以在以后再更改它。<br /><br /><br />请确认填写正确的网站首页访问路径或URL。<br /><br /><br />请确认填写正确的网站管理后台的路径或URL。',
