...
$LANG_INSTALL = array(
    'adminuser'                 => 'Uživatelské jméno administrátora',
    'back_to_top'               => 'Zpět nahoru',
    'calendar'                  => 'Načíst plugin kalendáře?',
    'calendar_desc'             => 'Online systém kalendářů a událostí. Obsahuje společný kalendář a osobní kalendáře pro uživatele webu.',
    ...
    'db_user'                   => 'Uživatelské jméno k databázi',
    'db_user_error'             => 'Uživatelské jméno databáze nemůže být prázdné.',
    'db_too_old'                => 'MySQL verze je příliš stará - Musíte mít MySQL v5.0.15 nebo novější',
    ...
    'forum_desc'                => 'Fórum pro online komunitu. Poskytuje komunitní spolupráci a interaktivitu.',
    ...
    'online_install_help'       => 'Online nápověda k instalaci',
    ...
    'php_req_version'           => 'glFusion vyžaduje PHP verzi 7.0.0 nebo novější.',
    ...
    'sitedata_help'             => 'Vyberte typ databáze, kterou chcete použít z rozbalovacího seznamu. To je obecně <strong>MySQL</strong>. Také zvolte, zda použít znakovou sadu <strong>UTF-8</strong> (toto by mělo být obecně kontrolováno u vícejazyčných stránek.<br /><br />Zadejte název hostitele databázového serveru. Toto nemusí být stejné jako váš webový server, takže zkontrolujte svého poskytovatele hostingu, pokud si nejste jistí.<br /><br />Zadejte název databáze. <strong>Databáze musí již existovat.</strong> Pokud neznáte název databáze, kontaktujte svého poskytovatele hostingu.<br /><br />Zadejte uživatelské jméno pro připojení k databázi. Pokud neznáte uživatelské jméno databáze, obraťte se na svého poskytovatele hostingu.<br /><br />Zadejte heslo pro připojení k databázi. Pokud neznáte heslo k databázi, kontaktujte svého poskytovatele hostingu.<br /><br />Zadejte prefix tabulky, který bude použit pro tabulky databáze. To je užitečné pro oddělení více stránek nebo systémů při použití jedné databáze.<br /><br />Zadejte název vašeho webu. Zobrazí se v záhlaví webu. Například glFusion nebo Marbles značek. Nemějte obavy, může být vždy později změněn.<br /><br />Zadejte slogan vašeho webu. Bude zobrazeno v záhlaví stránky pod názvem webu. Například synergie - stabilita - styl. Nebojte se, může být později vždy změněna.<br /><br />Zadejte hlavní e-mailovou adresu vašeho webu. Toto je e-mailová adresa pro výchozí účet správce. Nemějte obavy, může být vždy později změněn.<br /><br />Zadejte vaši e-mailovou adresu odpovědi. Bude použito pro automatické odesílání nových uživatelů, resetování hesla a dalších e-mailových upozornění. Nebojte se, můžete ho později změnit.<br /><br />Potvrďte, že se jedná o webovou adresu nebo adresu URL pro přístup k domovské stránce vašeho webu.<br /><br />Potvrďte, že se jedná o webovou adresu nebo URL adresu používanou pro přístup k administrátorské části vašeho webu.',
    ...
    'system_path_prompt'        => 'Zadejte úplnou absolutní cestu na vašem serveru do adresáře <strong>prive/</strong> glFusiona.<br /><br />Pro novou instalaci je to adresář, který obsahuje <strong>db-config. soubor hp.dist</strong> nebo pro aktualizaci a existující soubor <strong>db-config.php</strong>.<br /><br />Příklady adresáře:<br />/home/www/glfusion/private/<br />c:/www/glfusion/private/<br /><br /><strong>Nápověda:</strong> Z pohledu bezpečnosti, nejžádanější místo pro soukromý adresář / adresář je mimo kořenový adresář webu. Kořenový adresář je adresář, který slouží vašemu webovému hostiteli a který se týká kořenové url vašich stránek (http://www.yoursite.com/).<br /><br />Zdá se, že absolutní cesta k vašemu adresáři <strong>public_html/</strong> <i>(ne <strong>prive/</strong>)</i> je:<br /><br />%s<br /><br />Doporučujeme umístit svůj soukromý adresář někde mimo kořenový adresář, pokud to váš webový server umožňuje.<br /><br />Pokud váš webový server neumožňuje umístění souborů mimo kořenový adresář webu, postupujte prosím podle instrukcí na <a href="https://www.glfusion.org/wiki/glfusion:install:pathsetting" target="_blank">Instalace adresáře prive/ ve veřejném webovém prostoru</a> na glFusion Documentation Wiki.<br /><br /><strong>Pokročilé nastavení</strong> vám umožní přepsat některé z výchozích cest. Obecně nemusíte tyto cesty upravovat nebo zadávat, systém je automaticky určí.',
