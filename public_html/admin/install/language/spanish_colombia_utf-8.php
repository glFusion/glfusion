...
$LANG_INSTALL = array(
    ...
    'calendar' => '¿Cargar el módulo de calendario?',
    ...
    'content_plugins' => 'Contenido & Módulos',
    ...
    'correct_perms' => 'Por favor corrije los errores listados a continuación. Una vez que hayan sido corregidos, utilizaz el botón <b>Revisar</b> para validar el ambiente.',
    'current' => 'Actual',
    'database_exists' => 'La base de datos actualmente contiene tablas de glFusion. Por favor borra las tablas glFusion antes de iniciar la nueva instalación.',
    ...
    'dbconfig_not_found' => 'No es posible localizar el archivo db-config.php o db-config.php.dist. Por favor asegúrate de que has ingresado la ruta correcta a tu directorio "private".',
    'dbconfig_not_writable' => 'El archivo db-config.php no tiene definido el permiso de escritura. Por favor asegúrate de que el servidor web tiene permiso para escribir este archivo.',
    ...
    'filemgmt' => '¿Cargar el módulo de Administrador de archivos?',
    ...
    'forum' => '¿Cargar el módulo de Foro?',
    ...
    'links' => '¿Cargar el módulo de Enlaces?',
    ...
    'mediagallery' => '¿Cargar el módulo de Galería multimedia?',
    ...
    'missing_db_fields' => 'Por favor ingresa en todos los campos la información requerida de la base de datos.',
    ...
    'plugin_install' => 'Instalación de módulos',
    'plugin_upgrade_error' => 'Hubo un problema durante la actualización de %s modulos, por favor revise el archivo de registro: error.log, para más detalles.<br />',
    'plugin_upgrade_error_desc' => 'Los siguientes módulos no fueron actualizados. Por favor revisa el archivo de registro: error.log, para más detalles.<br />',
    'polls' => '¿Cargar el módulo de Encuesta?',
    ...
    'post_max_size' => 'glFusion te permite cargar módulos, imágenes y archivos. Deberías permitir al menos 8M como tamaño máximo de subida.',
    'previous' => 'Regresar',
    'proceed' => 'Proceder',
    'recommended' => 'Recomendado',
    'register_globals' => 'Si PHP <strong>register_globals</strong> está encendido, puede crear inconvenientes de seguridad.',
    'safe_mode' => 'Si PHP <strong>safe_mode</strong> está encendido, algunas funcionalidades de glFusion pueden no funcionar correctamente. Especialmente el módulo de Galería multimedia .',
    ...
    'session_error' => 'Tu sesión ha expirado. Por favor reinicie el proceso de instalación.',
    ...
    'siteconfig_exists' => 'Se ha encontrado un archivo siteconfig.php existente. Por favor borra ese archivo antes de iniciar la instalación.',
    'siteconfig_not_found' => 'No fue posible encontrar el archivo siteconfig.php, ¿Está seguro de que se trata de una actualización?',
    'siteconfig_not_writable' => 'El archivo siteconfig.php no tiene permisos de escritura, o el directorio en donde siteconfig.php está almacenado no tiene permisos de escritura. Por favor, corrije este inconveniente antes de proceder.',
    ...
    'upload_max_filesize' => 'glFusion te permite cargar módulos, imágenes y archivos. Deberías permitir al menos 8M para la carga.',
    ...
    'check_for_updates' => 'Ir a Panel de Control - Verificar Actualización para ver si hay alguna actualización disponible para glFusion o algún Módulo.',
);
...
$LANG_SUCCESS = array(
    ...
    2 => ' ¡Completado!',
    3 => 'Felicidades, hsa logrado exitosamente ',
    4 => ' glFusion. Por favor, toma un minuto para leer la información mostrada a continuación.',
    5 => 'Para ingresar en tu nuevo sitio glFusion, por favor utiliza esta cuenta:',
    6 => 'Nombre de usuario:',
    ...
    17 => 'y',
    18 => 'retroceder',
    19 => '<strong>Nota:</strong> Debido a que el modelo de seguridad ha cambiado, hemos creado una nueva cuenta con los privilegios necesarios para que administres tu nuevo sitio. El nombre de usuario para esta nueva cuenta es <b>NewAdmin</b> y la contraseña es <b>password</b>',
    20 => 'instalado',
    21 => 'actualizado'
);
?>
