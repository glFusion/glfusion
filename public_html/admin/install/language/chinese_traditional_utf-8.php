...
$LANG_INSTALL = array(
    ...
    'current'                   => '當前',
    'database_exists'           => '資料庫中已經存在glFusion的資料表。請在全新安裝前情況所有舊資料表。',
    'database_info'             => '資料庫資訊',
    'db_hostname'               => '資料庫主機',
    ...
    'filemgmt'                  => '載入下載管理插件？',
    'filemgmt_desc'             => '下載管理器，讓您非常容易就能提供按照目錄組織的檔下載服務。',
    'filesystem_check'          => '檔系統檢查',
    'forum'                     => '載入論壇插件？',
    'forum_desc'                => '一個線上論壇系統，提供社區協作與交流功能。',
    ...
    'links'                     => '載入友情鏈結插件？',
    'links_desc'                => '一個友情鏈結管理系統，提供按照目錄分類的友情鏈結。',
    'load_sample_content'       => '載入默認示例網站數據嗎？',
    'mediagallery'              => '載入多媒體管理插件？',
    'mediagallery_desc'         => '一個多媒體管理系統，不僅可以配置成一個簡單的相冊，還能支援音樂和電影。',
    ...
    'polls'                     => '載入投票插件？',
    'polls_desc'                => '一個線上投票系統，為您的用戶提功一個多樣的投票功能。',
    ...
    'site_noreply_email_error'  => '不監控不能為空。',
    ...
    'sitedata_help'             => '<br />從下拉功能表選擇資料庫類型。通常是<strong>MySQL</strong>。同時也選擇是否使用<strong>UTF-8</strong>字元集(對於多語言站點一般需要選擇該選項)。<br /><br /><br />輸入資料庫伺服器的主機名。可能會和您的web伺服器不同，當您不確定時請諮詢伺服器提供商。<br /><br /><br />輸入資料庫名稱。<strong>資料庫必須已經存在。</strong>如果您不知道資料庫的名字，請聯繫您的伺服器提供商。<br /><br /><br />輸入資料庫用戶名。如果您不知道資料庫用戶名，請聯繫伺服器提供商。<br /><br /><br />輸入資料庫密碼，如果您不知道該密碼請聯繫伺服器提供商。<br /><br /><br />輸入一個資料表首碼，表首碼可以用來在一個資料庫中區分多個網站的資料表。<br /><br /><br />輸入您網站的名字，它將會顯示為網站標題。例如glFusion或Mark\'s Marbles。不必擔心，您可以在以後再更改它。<br /><br /><br />請輸入網站副標題。它將會顯示在網站標題下方。例如synergy - stability - style。不必擔心，您可以在以後再更改它。<br /><br />輸入您網站的主電子郵件位址。該地址將被作為默認管理員的電郵.不必擔心，您可以在以後再更改它。<br /><br />輸入您網站的不監控電郵位址。該位址將被用來發送自動生成的電子郵件、重置密碼信、或其他提醒郵件。不必擔心，您可以在以後再更改它。<br /><br />請確認填寫正確的網站首頁訪問路徑或URL。<br /><br />請確認填寫正確的網站管理後臺的路徑或URL。',
