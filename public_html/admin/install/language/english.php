...
$LANG_INSTALL = array(
    ...
    8 => 'The installation script was unable to locate the db-config.php file. This is probably because you have moved them from their default location or did not rename db-config.php.dist to db-config.php when you uploaded the glFusion files. Please specify the paths to the files and directories below (or rename the .dist version to the .php version):',
