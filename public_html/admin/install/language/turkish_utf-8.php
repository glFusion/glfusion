...
$LANG_INSTALL = array(
    ...
    'db_too_old'                => 'MySQL Sürümü çok eski - MySQL v%s veya sonraki bir sürüme sahip olmalısınız',
    ...
    'sitedata_help'             => 'Açılır listeden kullanılacak veritabanı türünü seçin. Bu genellikle <strong>MySQL</strong>\'dir. Veritabanınız <strong>UTF-8</strong> harmanlamayı kullanacak şekilde ayarlanmalıdır.<br /><br />Veritabanı sunucusunun ana bilgisayar adını girin. Bu, web sunucunuzla aynı olmayabilir, bu nedenle emin değilseniz barındırma sağlayıcınıza danışın.<br /><br />Veritabanınızın adını girin. <strong>Veritabanı zaten mevcut olmalıdır.</strong> Veritabanınızın adını bilmiyorsanız, barındırma sağlayıcınızla görüşün.<br /><br />Veritabanına bağlanmak için kullanıcı adını girin. Veritabanı kullanıcı adını bilmiyorsanız, barındırma sağlayıcınızla iletişime geçin.<br /><br />Veritabanına bağlanmak için şifreyi girin. Veritabanı parolasını bilmiyorsanız, barındırma sağlayıcınızla görüşün.<br /><br />Veritabanı tabloları için kullanılacak bir tablo öneki girin. Bu, tek bir veritabanı kullanırken birden çok siteyi veya sistemi ayırmaya yardımcı olur.<br /><br />Sitenizin adını girin. Site başlığında görüntülenecektir. Örneğin, glFusion veya Yahya KARAGÖZ. Merak etmeyin, daha sonra her zaman değiştirilebilir.<br /><br />Sitenizin sloganını girin. Site başlığının altında site adının altında görüntülenecektir. Örneğin, sinerji - istikrar - tarz. Merak etmeyin, daha sonra her zaman değiştirilebilir.<br /><br />Sitenizin ana e-posta adresini girin. Bu, varsayılan Yönetici hesabının e-posta adresidir. Merak etmeyin, daha sonra her zaman değiştirilebilir.<br /><br />Sitenizin yanıtsız e-posta adresini girin. Yeni kullanıcı, parola sıfırlama ve diğer bildirim e-postalarını otomatik olarak göndermek için kullanılacaktır. Endişelenmeyin, daha sonra her zaman değiştirilebilir.<br /><br />Lütfen bunun sitenizin ana sayfasına erişmek için kullanılan web adresi veya URL olduğunu doğrulayın.<br /><br />Lütfen doğrulayın. bu, sitenizin yönetici bölümüne erişmek için kullanılan web adresi veya URL\'dir.',
    ...
    'system_path_prompt'        => 'Sunucunuzda glFusion\'ın <strong>private/</strong> dizinine giden tam, mutlak yolu girin.<br /><br />Yeni bir kurulum için, bu, <strong>db-config.php.dist</strong> dosyası veya yükseltme için ve mevcut <strong>db-config.php</strong> dosyası.<br /><br />Dizin Örnekleri:<br />/home/www/glfusion /private/<br />c:/www/glfusion/private/<br /><br /><strong>İpucu:</strong> Güvenlik açısından, private/ dizini için en çok istenen konum, dizinin dışındadır. web kökü. Web kökü, sitenizin kök url\'si (http://www.yoursite.com/) ile ilgili web barındırıcınız tarafından sunulan dizindir.<br /><br />Görünüşe göre, <strong>public_html/</strong> <i>(<strong>private/</strong> değil)</i> dizininiz:<br /><br />%s<br /><br /> Web barındırıcınız buna izin veriyorsa, private/ dizininizi web kökünün dışında bir yere yerleştirmenizi öneririz.<br /><br />Web barındırıcınız dosyaların web kökünün dışına yerleştirilmesine izin vermiyorsa, lütfen aşağıdaki adımları izleyin. <a href="https://www.glfusion.org/wiki/glfusion:install:pathsetting" target="_blank">private/ dizini genel web\'e yükleme ile ilgili talimatlar.',
    ...
    'glfusion_v2_header'        => 'glFusion v2 Yükseltme Gereksinimleri',
    'glfusion_v2_notes'         => 'glFusion v2.0 sunucu dosyalarının konumlarını değiştirmiştir, artık sitenizin bir private/data/ dizini ve web sunucusu tarafından yazılabilir bir public_html/data/ dizini olması gerekir.',
    'data_dir_error'            => '<strong>%s</strong> yolu, web sunucusunun bu konuma yazmasına izin vermek için uygun izinlere sahip değil. Lütfen devam etmeden önce bu hatayı düzeltin.',
);
...
$LANG_SUCCESS = array(
    ...
    17 => 've',
    18 => 'geri dön',
    19 => '<strong>Not:</strong> Güvenlik modeli değiştiğinden, yeni sitenizi yönetmek için ihtiyacınız olan haklara sahip yeni bir hesap oluşturduk. Bu yeni hesabın kullanıcı adı <b>NewAdmin</b> ve parolası <b>password</b>',
    20 => 'kurulu',
    21 => 'yükseltildi',
