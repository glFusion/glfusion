...
function glfusion_177()
{
    ...
    // update version number
    DB_query("INSERT INTO {$_TABLES['vars']} SET value='1.7.7',name='glfusion'",1);
    DB_query("UPDATE {$_TABLES['vars']} SET value='1.7.7' WHERE name='glfusion'",1);

}

function glfusion_178()
{
    global $_TABLES, $_CONF,$_VARS, $_FF_CONF, $_SPX_CONF, $_PLUGINS, $LANG_AM, $use_innodb, $_DB_table_prefix, $_CP_CONF;
    ...
    // update version number
    DB_query("INSERT INTO {$_TABLES['vars']} SET value='1.7.8',name='glfusion'",1);
    DB_query("UPDATE {$_TABLES['vars']} SET value='1.7.8' WHERE name='glfusion'",1);
...
function glfusion_1710()
{
    global $_TABLES, $_CONF,$_VARS, $_FF_CONF, $_SPX_CONF, $_PLUGINS, $LANG_AM, $use_innodb, $_DB_table_prefix, $_CP_CONF;

    $_SQL = array();

    // No SQL updates in 1.7.10
    ...
    // update version number
    DB_query("INSERT INTO {$_TABLES['vars']} SET value='1.7.10',name='glfusion'",1);
    DB_query("UPDATE {$_TABLES['vars']} SET value='1.7.10' WHERE name='glfusion'",1);
