...
function bbstyle(bbnumber) {
    ...
    if (bbnumber == -1) { // Close all open tags & default button names
        while (bbcode[0]) {
            ...
            buttext = eval('document.sig_form.addbbcode' + butnumber + '.value');
            eval('document.sig_form.addbbcode' + butnumber + '.value ="' + buttext.substr(0,(buttext.length - 1)) + '"');
        }
    ...
    if (donotinsert) {        // Close all open tags up to the one just clicked & default button names
        ...
        if (imageTag && (bbnumber != 14)) {        // Close image tag before adding another
            ...
            document.sig_form.addbbcode14.value = "Img";    // Return button back to normal state
            imageTag = false;
        }
        ...
        eval('document.sig_form.addbbcode'+bbnumber+'.value += "*"');
        txtarea.focus();
        return;
    }
    storeCaret(txtarea);
