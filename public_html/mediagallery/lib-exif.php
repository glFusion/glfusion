...
// +---------------------------------------------------------------------------+
// | $Id:: lib-exif.php 1989 2008-02-13 04:21:30Z mevans0263                  $|
// +---------------------------------------------------------------------------+
...
// |                                                                           |
// | Adapted for Media Gallery Geeklog Plugin by                               |
...
if (strpos ($_SERVER['PHP_SELF'], 'lib-exif.php') !== false)
{
    die ('This file can not be used on its own.');
}

require_once($_MG_CONF['path_html'] . 'exif.php');
require_once($_MG_CONF['path_html'] . 'JPEG.php');
