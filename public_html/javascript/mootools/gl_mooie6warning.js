...
var IEWarn = new Class(
{
    'initialize': function()
    {
            ...
            this.fx = new Fx.Morph(this.box, {duration: 1000}).set({'margin-top': $('iewarn').getStyle('margin-top').toInt(), 'opacity': 0});
            this.open = false;
