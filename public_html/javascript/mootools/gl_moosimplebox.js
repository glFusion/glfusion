...
var mooSimpleBox = new Class({
	...
	clickClose: function() {
		var myFx = new Fx.Tween( $(this.box), {duration: this.fadeSpeed} ).start('opacity', this.opacity, 0);			
		this.isVisible = false;
	},
	...
	fadeIn: function(){	
		...
		if(this.isVisible == false) {
			this.addHT();
			this.isVisible = true;
			var myFx = new Fx.Tween( $(this.box), {duration: this.fadeSpeed} ).start('opacity', 0, this.opacity);
		}
	},
