var gl_mooRotator_block = new Class({
    ...
    options: {
        ...
        delay: 5000,
        autoplay: false,
        blankimage: 'images/speck.gif'
    },
    initialize: function (a, b) {
        this.container = $(a);
        this.setOptions(b);
        this.images = this.container.getElements('.gl_moorotatorimage_block');
        this.content = this.container.getElements('.gl_moorotatortext_block');
        this.current = 0;
        this.build();
        this.attachEvents();
        this.status = 'pause';
    ...
    build: function () {
        ...
        this);
        var e = $$('.gl_moorotator_block').slice(1);
        e.each(function (a) {
            a.empty().dispose()
        });
