...
$_DATA[] = "INSERT INTO {$_TABLES['links']} (lid, cid, url, description, title, hits, date, owner_id, group_id, perm_owner, perm_group, perm_members, perm_anon) VALUES ('gllabs.org', 'geeklog-sites', 'http://www.gllabs.org/', 'Visit the gl Labs homepage for support, FAQs, updates, add-ons, and a great community.', 'gl Labs - Enhancing Geeklog', 123, NOW(), 1, 5, 3, 3, 2, 2);";
