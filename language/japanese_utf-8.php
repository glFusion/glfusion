...
$LANG04 = array(
    ...
    25 => 'パスワードを忘れた方',
    26 => 'ご登録頂いているユーザ名<em>または</em>メールアドレスの<em>どちらかを入力</em>して『送信』ボタンを押してください。ご登録のメールアドレス宛にパスワード再発行用のURL を記載したメールが送信されます。',
    27 => '新規登録',
    28 => '送信',
    29 => 'ログアウトしました：',
    30 => 'ログインしました:',
    ...
    86 => 'ユーザのすべての投稿を検索',
    87 => 'あなたのログイン名',
    88 => "誰か(おそらくあなた)が{$_CONF['site_name']}、<{$_CONF['site_url']}>のあなたのアカウント %s のパスワード変更の要求をされました。本当に変更を行いたい場合は次のリンクをクリックして下さい:\n\n",
    89 => "もし、実行したくない場合は、単にこのメッセージを無視して下さい。変更のリクエストは捨て去られ(あなたのパスワードは変更されないままとなり)ます。\n\n",
    90 => '以下のあなたのアカウントに新しいパスワードを入力できます。このフォームで設定するまでは、あなたの古いパスワードが有効なことに注意して下さい。',
    91 => '新しいパスワードを設定',
    92 => '新しいパスワードを入力',
...
$LANG21 = array(
    ...
    66 => '自動タグ',
    67 => '自動タグ使用許可',
    68 => 'このポータルブロックのフィードは表示するのに長すぎます。ブロックの設定画面でブロックに含める記事の最大数を設定するか、Geeklogの設定で最大数を設定してください。'
);
...
$LANG24 = array(
    ...
    49 => '右',
    50 => '左',
    51 => '<p>添付した画像は，自動タグで記述してください。書式は，[imageX]，[imageX_right]，[imageX_left]（Xは添付した画像の番号）（例 [image1]）。注意：添付した画像は記事内ですべて使用しなければ記事を保存できません。<br' . XHTML . '><p><b>プレビュー</b>: 画像付きの記事はドラフト（下書き）として保存して閲覧してください。プレビューボタンは画像が無いときにのみ利用できます。</p>',
    52 => '',
    ...
    75 => '全機能',
    76 => '公開オプション',
    77 => 'アドバンストエディタの利用は，ブラウザでJavaScriptが使える環境にする必要があります。このオプションは設定管理パネルで無効にできます。',
...
$LANG28 = array(
    ...
    53 => '登録済み',
    54 => '一括削除',
    55 => '「最後のログインを記録」のオプションを有効と、設定管理パネルで有効にしている場合だけ動作します。',
    ...
    75 => '最後に登録したユーザ ',
    76 => ' ヶ月の間に登録したユーザ',
    77 => '選択したユーザにサイト・ログインの督促のメールを送信',
    78 => '督促を送信',
    79 => '督促するユーザが選択されていません',
    80 => '督促の送信に成功しました',
    81 => 'アカウント%sを検証するために督促',
    82 => "あなたの{$_CONF['site_name']}のアカウントは%sからアクセスされていないため、あと30日以内にアクセスしないと停止されます。",
    83 => "あなたの{$_CONF['site_name']}のアカウントは作成されてから使用されていないため、アクセスしないでいると直に削除されます。",
    84 => "私たちのサイト: {$_CONF['site_url']}: あなたのログイン名は: %s",
    85 => 'もしパスワードを忘れたなら、以下のリンクをご使用ください: %s'
);
...
$MESSAGE = array(
    ...
    91 => '無効なURLが指定されました。',
    92 => "使用する前に<a href=\"{$_CONF['site_admin_url']}/sectest.php\">あなたのサイトのセキュリティをチェックを確認</a>して下さい!",
...
$LANG_DB_BACKUP = array(
    ...
    'not_found' => "パスの指定が間違っているか，mysqldumpが実行可能になっていません。<br' . XHTML . '><strong>\$_DB_mysqldump_path</strong>の設定をチェックしてください。<br' . XHTML . '>現在の設定は，\n<var>{$_DB_mysqldump_path}</var>です。",
...
$LANG_PDF = array(
    1 => 'PDF機能は無効',
    2 => 'ドキュメントは変換されませんでした。受け取ったドキュメントを処理できませんでした。XHTML標準によって書かれたHTML形式のドキュメントだけを用意したことを確認して下さい。過度に複雑なHTMLのドキュメントは正しく変換されなかったり、まったく変換されなかったり、することがあります。ドキュメントの変換結果は0バイトのサイズだったので、削除しました。ドキュメントが変換可能だと確信されてる場合は、もう一度実行してみてください。',
    3 => 'PDFの生成に不明なエラーが発生しました。',
    4 => 'ページのデータが与えられていないか、以下の、この場限りのPDF生成ツールを使用してください。このページが何かエラーのためだと思う場合は、システムの管理者に連絡してください。もしくは以下のフォームから、ad-hocな方式によるPDFの生成を行ってみてください。',
    5 => 'ドキュメントを読み込み中です。',
    6 => 'ドキュメントを読み込むまでしばらくお待ち下さい。',
    7 => '下のボタンでマウスの右ボタンをクリックしたメニューから、「対象を保存...」または「リンクの場所を保存...」を選択してドキュメントのコピーを保存してください。',
    8 => '設定ファイルに指定された HTMLDoc バイナリのパスが誤っているか、システムが実行できません。この問題がずっと続く場合は、サイトの管理者に連絡を取って下さい。',
    9 => 'PDF生成',
    10 => 'これはad-hocなPDF生成ツールです。URLで指定した内容をPDFに変換しようとします。この機能では適切に変換されないWebページもあることに注意してください。これはHTMLDoc PDF生成ツールの制限なので、このサイトの管理者に報告しないで下さい。',
    11 => 'URL',
    12 => 'PDFを生成!',
    13 => 'このサーバのPHP設定はURLをfopen()コマンドに使用することを許可していません。システム管理者はphp.iniを編集して、allow_url_fopenをOnにしなければなりません。',
    14 => '要求したPDFは存在しないか、ファイルへ不正なアクセスをしようとしました。'
);
...
$LANG_confignames['Core'] = array(
    'path_html' => 'HTMLパス',
    'site_url' => 'サイトURL',
    'site_admin_url' => '管理URL',
    'site_mail' => 'サイトの連絡先メールアドレス',
    'noreply_mail' => '返信を受けないメールアドレス',
    'site_name' => 'サイト名',
    'site_slogan' => 'スローガン',
    'microsummary_short' => 'マイクロサマリ',
    'path_log' => 'ログ',
    'path_language' => '言語',
    'backup_path' => 'バックアップ',
    'path_data' => 'データ',
    'path_images' => '画像',
    'path_pear' => 'Pearのパス',
    'have_pear' => 'Pearをインストール済み?',
    'mail_settings' => 'メール送信設定',
    'allow_mysqldump' => 'mysqldumpの使用の許可',
    'mysqldump_path' => 'mysqldumpのパス',
    'mysqldump_options' => 'mysqldumpのオプション',
    'theme' => 'テーマ',
    'menu_elements' => 'メニュー要素',
    'path_themes' => 'テーマのパス',
    'disable_new_user_registration' => '新規ユーザの登録を無効',
    'allow_user_themes' => 'ユーザにテーマの選択を許可',
    'allow_user_language' => 'ユーザに言語の選択を許可',
    'allow_user_photo' => 'ユーザの写真を許可',
    'allow_username_change' => 'ユーザ名の変更を許可',
    'allow_account_delete' => 'アカウントの削除を許可',
    'hide_author_exclusion' => '作者の隠蔽を許可',
    'show_fullname' => '氏名を表示',
    'show_servicename' => 'サービス名を表示',
    'custom_registration' => 'カスタム登録を有効',
    'user_login_method' => 'ユーザのログイン方式',
    'spamx' => 'Spam-Xのアクション',
    'sort_admin' => 'リンクをソート',
    'language' => '言語',
    'locale' => 'ロケール',
    ...
    'cookie_tzid' => '時間帯のクッキー名',
    'cookie_ip' => 'IPをクッキーに埋め込む?',
    'default_perm_cookie_timeout' => '永続的なクッキーの期限',
    'session_cookie_timeout' => 'セッションの期限',
    'cookie_path' => 'クッキーのパス',
    'cookiedomain' => 'クッキーのドメイン',
    'cookiesecure' => 'クッキーのセキュア属性',
    'lastlogin' => '最後のログインを記録?',
    'pdf_enabled' => 'PDFを有効?',
    'num_search_results' => '検索結果の数',
    'loginrequired' => 'ログインが必要?',
    'submitloginrequired' => '投稿にログインが必要?',
    'commentsloginrequired' => 'コメントにログインが必要?',
    'statsloginrequired' => '統計の参照にログインが必要?',
    'searchloginrequired' => '検索にログインが必要?',
    'profileloginrequired' => 'プロファイルにログインが必要?',
    'emailuserloginrequired' => 'メール送信にログインが悲調?',
    'emailstoryloginrequired' => 'メール投稿にログインが必要?',
    'directoryloginrequired' => 'ディレクトリのログインが必要?',
    'storysubmission' => '投稿記事をキューに保持?',
    'usersubmission' => 'ユーザ登録依頼をキューに保持?',
    'listdraftstories' => 'ドラフトの記事を一覧?',
    'notification' => '通知',
    'postmode' => 'デフォルトの投稿のモード',
    'speedlimit' => '投稿速度の制限',
    'skip_preview' => 'プレビューを飛ばした投稿',
    'advanced_editor' => '高度なエディタ?',
    'wikitext_editor' => 'ウィキテキスト エディタ?',
    'cron_schedule_interval' => 'Cronの時間間隔',
    'sortmethod' => '話題をソート',
    'showstorycount' => '記事の数を表示?',
    'showsubmissioncount' => '投稿数を表示?',
    'hide_home_link' => 'Homeのリンクを隠す?',
    'whosonline_threshold' => 'セッションの閾値',
    'whosonline_anonymous' => 'ゲストから名前を隠す?',
    'emailstories' => '日毎の要約を有効?',
    'emailstorieslength' => '記事の長さ',
    'emailstoriesperdefault' => '新規ユーザに有効?',
    'allow_domains' => '許可するドメイン',
    'disallow_domains' => '許可しないドメイン',
    'newstoriesinterval' => '新しい記事の間隔',
    'newcommentsinterval' => '新しいコメントの間隔',
    'newtrackbackinterval' => '新しいトラックバックの間隔',
    'hidenewstories' => '新しい記事を隠す',
    'hidenewcomments' => '新しいコメントを隠す',
    'hidenewtrackbacks' => '新しいトラックバックを隠す',
    'hidenewplugins' => '新しいプラグインのエントリを隠す',
    'title_trim_length' => 'タイトルを切り詰める長さ',
    'trackback_enabled' => 'トラックバックを有効?',
    'pingback_enabled' => 'ピングバックを有効?',
    'ping_enabled' => 'ピングを有効?',
    'trackback_code' => 'デフォルトでトラックバック',
    'multiple_trackbacks' => '複数回のトラックバック',
    'trackbackspeedlimit' => 'トラックバックの速度を制限',
    'check_trackback_link' => 'トラックバックのリンクを確認',
    'pingback_self' => '自分自身にピングバック?',
    'pingback_excerpt' => 'ピングバックの抜粋を作成?',
    'link_documentation' => 'ドキュメントにリンク?',
    'link_versionchecker' => 'バージョンチェッカにリンク?',
    'maximagesperarticle' => '記事毎の最大画像数',
    'limitnews' => '1ページの記事',
    'minnews' => '1ページの最小の記事',
    'contributedbyline' => '作者のユーザ名を表示?"',
    'hideviewscount' => '参照数を隠す?',
    'hideemailicon' => '電子メールのアイコンを隠す?',
    'hideprintericon' => '印刷のアイコンを隠す?',
    'allow_page_breaks' => '複数ページの記事を許可?',
    'page_break_comments' => '複数ページの記事のコメント',
    'article_image_align' => '話題のアイコンの表示位置',
    'show_topic_icon' => '話題のアイコンを表示?',
    'draft_flag' => '記事のデフォルトをドラフト',
    'frontpage' => 'デフォルトのフロントページ',
    'hide_no_news_msg' => '"記事がありません"のメッセージを隠す?',
    'hide_main_page_navigation' => 'メインページへのナビゲーションを隠す?',
    'onlyrootfeatures' => 'Rootだけが注目記事を設定?',
    'aftersave_story' => '記事を保存した後',
    'aftersave_user' => 'ユーザを保存した後',
    'show_right_blocks' => '常に右ブロックを表示?',
    'showfirstasfeatured' => '最初の記事を注目記事として表示?',
    'backend' => 'フィードを有効?',
    'rdf_file' => 'シンディケーションの出力フォルダ',
    'rdf_limit' => 'フィードの上限',
    'rdf_storytext' => 'フィード中の記事の長さ',
    'rdf_language' => 'フィードの言語',
    'syndication_max_headlines' => 'ヘッドライン(ポータルブロック)の最大数',
    'copyrightyear' => '著作権の年',
    'image_lib' => '画像ライブラリ',
    'path_to_mogrify' => 'Mogrifyのパス',
    'path_to_netpbm' => 'Netpbmのパス',
    'debug_image_upload' => '画像アップロードをデバッグ?',
    'keep_unscaled_image' => '元のサイズの画像を保持?',
    'allow_user_scaling' => 'ユーザにサイズ変更を許可?',
    'max_image_width' => '画像の最大幅?',
    'max_image_height' => '画像の最大高さ?',
    'max_image_size' => '画像|ファイル|の最大ファイル・サイズ?',
    'max_topicicon_width' => '話題アイコンの最大幅?',
    'max_topicicon_height' => '話題アイコンの最大高さ?',
    'max_topicicon_size' => '話題アイコンの最大ファイル・サイズ?',
    'max_photo_width' => '写真の最大幅?',
    'max_photo_height' => '写真の最大高さ?',
    'max_photo_size' => '写真の最大ファイル・サイズ?',
    'use_gravatar' => '回転を使用?',
    'gravatar_rating' => '許可する回転の割合',
    'force_photo_width' => '写真の幅の矯正',
    'default_photo' => 'デフォルトの写真',
    'commentspeedlimit' => 'コメントの頻度の制限',
    'comment_limit' => 'コメント数の制限',
    'comment_mode' => 'コメントのモード',
    'comment_code' => 'コメントのデフォルト',
    'passwordspeedlimit' => 'パスワード入力の頻度の制限',
    'login_attempts' => '最大のログイン試行回数',
    'login_speedlimit' => 'ログイン試行の頻度の制限',
    'user_html' => 'ユーザのHTML',
    'admin_html' => 'AdminのHTML',
    'skip_html_filter_for_root' => 'RootへのHTMLフィルタを適用しない?',
    'allowed_protocols' => '許可されたプロトコル',
    'disable_autolinks' => '自動リンクを無効?',
    'censormode' => '監視モード?',
    'censorreplace' => '監視の置き換えテキスト',
    'censorlist' => '監視のリスト',
    'ip_lookup' => 'IPの逆引き',
    'url_rewrite' => 'URL書き換えを有効',
    'default_permissions_block' => 'ブロックのデフォルトの許可',
    'default_permissions_story' => '記事のデフォルトの許可',
    'default_permissions_topic' => '話題のデフォルトの許可',
    'atom_max_stories' => 'Webサービスの最大記事数',
    'disable_webservices' => 'Webサービスを無効?',
    'restrict_webservices' => 'Webサービスを制限?'
);
...
$LANG_fs['Core'] = array(
    ...
    'fs_whosonline_block' => 'オンラインユーザ・ブロック',
    'fs_daily_digest' => '日毎の要約',
    'fs_whatsnew_block' => '新着ブロック',
    'fs_trackback' => 'トラックバック',
    'fs_pingback' => 'ピングバック',
    'fs_story' => '記事',
    'fs_theme_advanced' => '進んだ設定',
    'fs_syndication' => 'シンディケーション',
    'fs_imagelib' => '画像ライブラリ',
    'fs_upload' => 'アップロード',
    'fs_articleimg' => '記事中の画像',
    'fs_topicicon' => '話題アイコン',
    'fs_userphoto' => '写真',
    'fs_gravatar' => '回転',
    'fs_comments' => 'コメント',
    ...
    'fs_censoring' => '監視',
    'fs_iplookup' => 'IP逆引き',
    'fs_perm_story' => '記事のデフォルトのアクセス権',
    'fs_perm_topic' => '話題のデフォルトのアクセス権',
    'fs_perm_block' => 'ブロックのデフォルトのアクセス権',
...
$LANG_configselects['Core'] = array(
    ...
    9 => array('ページに進む' => 'item', 'リストを表示' => 'list', 'ホームを表示' => 'home', '管理画面を表示' => 'admin'),
    10 => array('なし' => '', 'Netpbm' => 'netpbm', 'ImageMagick' => 'imagemagick', 'gdLib' => 'gdlib'),
    11 => array('平坦' => 'flat', '入れ子' => 'nested', 'スレッド' => 'threaded', 'コメントなし' => 'nocomment'),
    12 => array('アクセス禁止' => 0, '読むだけ' => 2, '読み書き' => 3),
    13 => array('無視' => 0, '速度制限ありで許可' => 1, '無条件に許可' => 2),
    14 => array('日曜' => 'Sun', '月曜' => 'Mon'),
    15 => array('数値順' => 'sortnum', 'アルファベット順' => 'alpha'),
    16 => array('ログイン不要' => 0, '高度な検索だけ' => 1, '単純と高度な検索' => 2),
