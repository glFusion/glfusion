...
$LANG01 = array(
    ...
    39 => 'Osveži',
    40 => 'Izkljuèene so <tt>register_globals = Off</tt> v <tt>php.ini</tt>. Geeklog zahteva <tt>register_globals</tt> <strong>vkljuèene</strong>. Preden nadaljuješ, jih prosim <strong>vkljuèi</strong> in ponovno zaženi spletni strežnik.',
    41 => 'Gostje',
    42 => 'Prispeval/a:',
    43 => 'Odgovori na to',
    44 => 'Starš',
...
$LANG04 = array(
    ...
    13 => 'Pošlji noèni pegled',
    14 => 'Geslo se generira nakljuèno. Priporoèljivo je, da geslo takoj spremenite. To storite s klikom na Informacije o raèunu v  meniju Osebne nastavitve. Za spremembe osebnih nastavitev se je treba prijaviti v sistem.',
    ...
    23 => "Ustvarjenje uporabniškega raèuna omogoèa uporabo vseh ugodnosti na spletni strani {$_CONF['site_name']}. Lahko boš v svojem imenu objavljal komentarje ter oddajal èlanke in slike.  Brez uporabniškega raèuna lahko objavljaš le anonimno. <font color=red>Elektronski naslovi registriranih uporabnikov na tej spletni strani ne bodo <b><i>nikoli</i></b> javno prikazani.",
    ...
    55 => 'Èe pustiš prazno, se bodo ohranile privzete nastavitve. Èe zaèneš izbirati bloke, izberi vse, ki jih želiš, ker se bodo prikazali samo izbrani (brez privzetih). Privzeti vnosi so prikazani <B> krepko</B>.',
    56 => 'Avtorji',
    57 => 'Oblikovanje',
    58 => 'Uredi po',
    ...
    71 => "Ena od posebnosti spletne strani {$_CONF['site_name']} je možnost popolnega prilagajanja izgleda posameznemu uporabniku.  Èe hoèeš uporabiti to možnost, se moraš najprej <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">prijaviti</a> na {$_CONF['site_name']}. Si že postal/a registrirani uporabnik? Prijavi se!",
    72 => 'Tema',
    73 => 'Jezik',
    ...
    92 => 'Vpiši novo geslo',
    93 => 'Tvoja zadnja zahteva za novo geslo je bila sprejeta pred %d sekundami. Ta stran zahteva, da med spremembami gesla preteè vsaj %d sekund.',
    94 => 'Izbriši raèun "%s"',
    ...
    117 => 'Tvoj raèun trenutno èaka na potrditev skrbnika. Dokler raèun ni potrjen, se ne moreš prijaviti.',
    118 => "Tvoj raèun na strani {$_CONF['site_name']} je sedaj potrdil skrbnik. Sedaj se lahko na spletno stran prijaviš na spodnji povezavi s svojim uporabniškim imenom (<username>) in geslom, ki si ju prejel po e-pošti.",
    ...
    140 => '<li>Èe je možnost Brez ikone rubrike potrjena, ikone rubrik ne bodo prikazane</li><li>Èe je možnost Brez okenca potrjena, bodo prikazani le skrbnikov meni, uporabniški meni in teme<li>Nastavi najveèje število na eni strani prikazanih èlankov</li><li>Nastavi svojo temo in želeni zapis datuma</li>',
...
$LANG08 = array(
    ...
    24 => 'Èlanek lahko komentirate tukaj:',
    25 => 'Za uporabo te funkcije se je treba prijaviti. Prijava nam pomaga prepreèevati morebitne zlorabe sistema.',
...
$LANG10 = array(
    ...
    25 => 'Deset najbolj Trackback komentiranih èlankov',
...
$LANG12 = array(
    ...
    8 => 'Oddaj',
    9 => 'Pri oddajanju podatkov za uporabo na tem spletnem mestu prosim upoštevaj naslednja priporoèila: <ul><li>Izpolni vsa polja.<li>Poskrbi, da bodo podatki celostni in toèni.<li>Upoštevaj pravopis.<li>Preveri, da delujejo vse povezave.<li><font color=red>Pošiljaj <b>samo èlanke in dogodke</b>. Komentarje vpisuj pod posamezne èlanke, za splošne debate in mnenja pa uporabi forum.</font><li>V naslov NE piši celih besed z VELIKIMI èrkami. Besedila, ki bodo zapisana z velikimi èrkami, bomo v celoti prekodirali v male èrke.</li> <br' . XHTML . '> <b>Pri vnašanju dogodka ali oglasa: </b><li>Uredništvo si pridržuje pravico, da ne objavi dogodkov in oglasov, ki niso v skladu z navedenimi pogoji, ki imajo sporno vsebino in/ali ki niso v skladu z veljavno zakonodajo Republike Slovenije.<li>Pri vpisu ponudbe za  delavnice, seminarje, storitve, zaposlitve idr. v oknu z besedilom oglasa (polje opis dogodka ali vsebina èlanka)  v skladu z zakonodajo <b>obvezno navedite še</b><ul><li>naziv podjetja ter ime in priimek odgovorne osebe oziroma ime in priimek naroènika oglasa (èe ne gre za podjetje ali organizacijo) ,<li>sedež podjetja, organizacije ali naslov naroènika oglasa (èe ne gre za podjetje).</ul>',
    10 => 'Naslov',
    11 => '',
    12 => 'Datum zaèetka',
    13 => 'Datum zakljuèka',
...
$LANG21 = array(
    ...
    50 => '',
    51 => 'zaèni s http://',
    52 => 'Èe pustiš prazno, se ikona za pomoè za ta blok ne bo izpisala!',
    53 => 'Omogoèeno',
    54 => 'shrani',
    55 => 'preklièi',
    56 => 'izbriši',
...
$LANG24 = array(
    ...
    40 => '',
    41 => "Poskušaš dostopiti do èlanka, do katerega nimaš pravice dostopa. Ta poskus je bil zabeležen in shranjen. Èlanek lahko samo preberete, ne morete pa ga urejati. Ko konèaš, pojdi prosim nazaj na <a href=\"{$_CONF['site_url']}/admin/story.php\">zaslon za skrbništvo èlankov</a>.",
    ...
    44 => '',
    45 => '',
    46 => '<b>OPOMBA:</b> Èe tu nastaviš datum v prihodnosti, èlanek ne bo objavljen do izbranega datuma. Do tega datuma èlanka ne bo niti v RDF niti ne bo vkljuèn v iskalnik in statistiène strani.',
    47 => 'Slike',
    48 => 'slika',
    49 => 'desno',
    50 => 'levo',
    ...
    75 => 'Vse funkcije',
    76 => 'Možnosti objave',
    77 => ' Za napredno urejanje mora biti Javascript omogoèen. Možnost lahko onemogoèite na glavni strani config.php.',
...
$MESSAGE = array(
    ...
    73 => 'Med deinstaliranjem vtiènika je prišlo do napake. Za podrobnosti glej error.log.',
...
$LANG_ACCESS = array(
    ...
    'newgroupmsg' => 'Za spreminjanje ali izbris skupine kliknite na njeno ikono za urejanje spodaj. Èe hoèete oblikovati novo skupino, kliknite na "Ustvari" zgoraj. Jedrnih skupin ni mogoèe odstraniti, ker jih uporablja sistem.',
