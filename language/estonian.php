...
$LANG01 = array(
    ...
    57 => 'Salasõna',
    58 => 'Logi sisse',
    59 => "Pole veel kontot? Logi sisse <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">uue kasutajana</a>",
    ...
    119 => "Kaotasid oma <a href=\"{$_CONF['site_url']}/users.php?mode=getpassword\" rel=\"nofollow\">salasõna?</a>",
...
$LANG04 = array(
    ...
    66 => "Võib-olla kirjutasid kasutajatunnuse või salasõna valesti. Palun proovi alloleva vormi abil uuesti. Või oled <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">uus kasutaja?</a>",
    67 => 'Liige alates',
    68 => 'Mäleta mind',
    69 => 'Kui kaua peale sisselogimist peaksin sind mäletama?',
    70 => "Kohanda {$_CONF['site_name']} sisu ja välimust",
    71 => "{$_CONF['site_name']} lehe üks headest omadustest on see, et sa võid määrata, millist sisu sulle näidatakse ja sa saad muuta lehe üldist välimust. Selle kasutamiseks pead sa kõigepealt <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">registreeruma</a> {$_CONF['site_name']} lehel.   Kui sa oled juba registreerinud, siis logi palun sisse.",
    72 => 'Teema',
    73 => 'Keel',
    74 => 'Saidi välimus',
    ...
    123 => "Kas sa oled <a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">uus kasutaja?</a>",
...
$LANG32 = array(
    ...
    10 => '<br' . XHTML . '><b>Hetkel pole installeeritud ühtegi pluginat.</b><br' . XHTML . '><br' . XHTML . '>',
...
$LANG_ACCESS = array(
    ...
    'storydenialmsg' => "Sul ei ole õigust seda lugu vaadata. Selle põhjuseks võib olla, et sa ei ole {$_CONF['site_name']} lehel registreerunud kasutaja.  Palun <a href=\"users.php?mode=new\" rel=\"nofollow\"> registreeru {$_CONF['site_name']} lehe kasutajaks </a>, et saada kõiki registreerunud kasutaja õigusi",
...
$LANG_DB_BACKUP = array(
    ...
    'not_found' => "Ebakorrektne tee programmini või mysqldump pole käivitatav.<br" . XHTML . ">Kontrolli config.php failis <strong>\$_DB_mysqldump_path</strong> definitsiooni.<br" . XHTML . ">Hetkel on muutuja väärtuseks: <var>{$_DB_mysqldump_path}</var>",
...
$LANG_TRB = array(
    ...
    'trackback_note' => 'Trackbakkommentaari saatmiseks mine lugude loetelusse ja klõpsa loo juures "". Klõpsa järgmisel lingil, et <a href="%s"> saata lugudega sidumata trackbackkommentaari.</a>',
