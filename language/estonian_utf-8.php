...
$LANG_DB_BACKUP = array(
    ...
    'not_found' => "Ebakorrektne tee programmini või mysqldump pole käivitatav.<br" . XHTML . "Kontrolli seadistuses <strong>\$_DB_mysqldump_path</strong> definitsiooni.<br" . XHTML . "Hetkel on muutuja väärtuseks: <var>{$_DB_mysqldump_path}</var>",
...
$LANG_TRB = array (
    ...
    'trackback_note'     => 'Trackbackkommentaari saatmiseks mine lugude loetelusse ja klõpsa loo juures "' . $LANG24[21] . '". Klõpsa järgmisel lingil, et <a href="%s"> saata lugudega sidumata trackbackkommentaari.</a>',
...
$LANG_confignames['Core'] = array(
    ...
    'show_servicename' => "Show Näita teenusenimi",
    ...
    'dateonly' => "Ainult kuupäev formaat", 
    'timeonly' => "Ainult aeg formaat",
